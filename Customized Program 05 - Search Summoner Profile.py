    ...
    while True:
        ...
        if search_LoL:
            ...
            while True:
                ...
                if matchId_str == "":
                    ...
                    if matchId_str == "3":
                        ...
                        if old_LoLMatch_detected and update_unsaved_only:
            ...
            if len(LoLMatchIDs) > 0:
                ...
                if use_sgp:
                    LoLGame_stat_statistics_output_order: list[int] = [0, 112, 146, 130, 131, 144, 127, 145, 68, 21, 16, 13, 25, 26, 11, 18, 22, 14, 29, 15, 20, 30, 19, 24, 222, 213, 623, 179, 54, 620, 621, 96, 132, 82, 150, 52, 51, 55, 218, 219, 181, 182, 183, 184, 185, 186, 187, 216, 195, 207, 196, 208, 197, 209, 198, 210, 199, 211, 200, 212, 95, 64, 45, 224, 225, 226, 229, 230, 98, 94, 99, 49, 72, 71, 74, 73, 66, 165, 128, 113, 172, 151, 162, 155, 115, 102, 167, 154, 114, 101, 166, 97, 61, 60, 58, 59, 159, 160, 164, 156, 157, 116, 103, 168, 62, 174, 177, 176, 134, 175, 65, 79, 227, 80, 228, 93, 57, 161, 105, 153, 158, 169, 170, 83, 84, 106, 108, 171, 85, 107, 67, 47, 109, 110, 100, 48, 56, 78, 129, 126, 111, 43, 44, 104, 69, 70, 173, 63, 46, 81, 152, 163, 135, 137, 139, 140, 223, 142, 143, 597, 611, 603, 599, 604, 600, 605, 601, 606, 602, 615, 613, 616, 614, 593, 591, 592, 147, 75, 77, 231, 117, 141, 667, 653, 638, 723, 669, 666, 670, 642, 655, 710, 687, 682, 716, 696, 707, 700, 684, 673, 712, 699, 683, 672, 711, 668, 650, 649, 647, 648, 704, 705, 709, 701, 702, 685, 674, 713, 651, 718, 721, 720, 689, 719, 654, 660, 661, 665, 646, 706, 676, 698, 703, 724, 714, 715, 663, 664, 677, 678, 656, 640, 679, 680, 671, 641, 645, 659, 688, 686, 681, 636, 637, 675, 657, 658, 717, 652, 639, 662, 697, 708, 690, 691, 692, 693, 722, 694, 695, 797, 745, 744, 768, 754, 739, 825, 826, 828, 770, 767, 771, 743, 756, 812, 788, 783, 818, 798, 809, 802, 785, 774, 814, 801, 784, 773, 813, 769, 751, 750, 748, 749, 806, 807, 811, 803, 804, 786, 775, 815, 752, 820, 823, 822, 790, 821, 755, 761, 762, 829, 766, 747, 808, 777, 805, 800, 827, 816, 817, 764, 765, 757, 741, 780, 781, 778, 779, 772, 742, 746, 760, 789, 787, 782, 737, 738, 776, 758, 759, 819, 753, 740, 763, 799, 810, 791, 792, 793, 794, 824, 795, 796, 233, 234, 235, 236, 237, 238, 239, 240, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 376, 266, 267, 268, 269, 270, 271, 272, 273, 274, 275, 276, 277, 377, 278, 279, 280, 378, 281, 282, 283, 284, 285, 286, 287, 288, 289, 290, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 301, 302, 303, 304, 305, 306, 307, 308, 309, 310, 311, 312, 313, 314, 379, 315, 316, 317, 318, 319, 320, 321, 322, 323, 324, 325, 380, 326, 327, 328, 329, 330, 331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 342, 343, 344, 345, 346, 347, 348, 349, 350, 351, 352, 353, 354, 355, 356, 357, 358, 359, 360, 361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374, 375, 381, 382, 383, 384, 385, 386, 387, 388, 389, 390, 391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410, 411, 412, 413, 414, 415, 416, 417, 418, 419, 420, 421, 422, 423, 424, 425, 426, 427, 428, 429, 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442, 443, 444, 445, 446, 447, 448, 449, 450, 451, 452, 453, 454, 455, 456, 457, 458, 459, 460, 461, 462, 463, 464, 465, 466, 467, 468, 469, 470, 471, 472, 473, 474, 475, 476, 477, 478, 479, 480, 481, 482, 483, 484, 485, 486, 487, 488, 489, 490, 491, 492, 493, 494, 495, 496, 497, 498, 499, 500, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510, 511, 512, 513, 514, 515, 516, 517, 518, 519, 520, 521, 522, 523, 524, 525, 526, 527, 528, 529, 530, 531, 532, 533, 534, 535, 536, 537, 538, 539, 540, 541, 542, 543, 544, 545, 546, 547, 548, 549, 550, 551, 552, 553, 554, 555, 556, 557, 558, 559, 560, 561, 232]
                else:
                ...
                if LoLGamePlayed and save_all_json:
        ...
        if search_TFT:
                ...
                if matchId_str == "":
                    ...
                    if matchId_str == "3":
                        if old_TFTMatch_detected:
                            ...
                            update_unsaved_only_str: str = logInput()
                            update_unsaved_only: bool = not bool(update_unsaved_only_str)
                        if old_TFTMatch_detected and update_unsaved_only:
            ...
            if len(TFTMatchIDs) > 0:
                ...
                if len(TFTGameIDs) > 0 and save_all_json:
                    logPrint('对局序号列表已保存在“%s”文件夹下。\nMatchId list is saved in the folder "%s".\n' %(folder, folder))
