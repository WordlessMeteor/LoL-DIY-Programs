    ...
    while True:
        ...
        if summoner_name == "0":
            ...
            if "errorCode" in info and info["httpStatus"] == 404:
                ...
                if region == "TENCENT":
                    folder = "召唤师信息（Summoner Information）\\" + "国服（TENCENT）" + "\\" + platform_TENCENT[client_info["--rso_platform_id"]] + "\\" + displayName
                elif region == "GARENA":
