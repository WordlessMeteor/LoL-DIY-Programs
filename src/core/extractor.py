...
class MapExtractor(LoLDataExtractor):
    ...
    def build_map_dataframe(self, debug: bool = False, paths: Optional[list[str]] = None) -> int:
        ...
        ##准备表头本地化信息（Prepare the map header localization）
        map_header_l10n: dict[str, str] = {"key": "主键", "mModeName": "模式代号", "Configs": "模式基础信息目录", "ConfigsClient": "客户端配置目录", "mChampionLists": "英雄列表", "itemLists": "装备目录", "{dc2bc473}": "模式特定装备目录", "mItemShopData": "商店数据", "AdditionalPropertyDataPaths": "附加说明文件路径", "AnnouncementsMapping": "通告映射", "mRelativeColorization": "采用相对着色法", "mCursorConfig": "指针配置文件", "mCursorConfigUpdate": "新版指针配置文件", "mStatsUiData": "属性面板数据", "mChampionIndicatorEnabled": "英雄指示器可用性", "JungleRecommendationMapInformation": "推荐打野路线信息", "DefaultJunglePathRecommendation": "默认打野路线", "StartupCheats": "启动指令", "mExperienceCurveData": "经验曲线算法", "mExperienceModData": "经验获取调整", "mDeathTimes": "复活计时器", "mMapLocators": "地图物件坐标", "mPerkReplacements": "符文替换信息", "mGameModeConstants": "游戏模式常数", "DefaultRespawnPoints": "默认重生位置", "mGameplayConfig": "游戏玩法信息", "mSurrenderSettings": "投降设置", "mAutoItemPurchasingConfig": "装备构件购买信息", "LevelControllers": "荣誉等级管理", "__type": "数据类型", "Configs SmartPingData {5aa830e8}": "", "Configs SmartPingData {aa8eb438}": "", "Configs SmartPingData {1e98bb0e}": "", "Configs CharacterQuestListConfig {6f7129e6}": "", "Configs CharacterQuestListConfig {702d99a3}": "", "Configs CharacterQuestListConfig CharacterQuestList": "英雄彩蛋列表", "Configs CharacterQuestListConfig CharacterQuestDefinitionsList": "英雄彩蛋定义", "Configs ReciprocityConfig throttleLimit": "", "Configs ReciprocityConfig {8e26fcb2}": "", "Configs {6b91544a} BlurTextures": "启用模糊纹理", "Configs {6b91544a} UpscaleTextures": "启用放大纹理", "Configs {6b91544a} {46edf5aa}": "", "Configs {6b91544a} VfxSystems": "视觉特效系统", "Configs {9f30b8a6} BaseGold": "击杀基础金币", "Configs {9f30b8a6} FirstBloodBonus": "第一滴血额外金币", "Configs {9f30b8a6} AssistDurationOverride": "助攻窗口时间", "Configs {9f30b8a6} {11f10a40}": "", "Configs {9f30b8a6} {937cc95a}": "", "Configs {9f30b8a6} {08c1b120}": "", "Configs {9f30b8a6} {1eacb90a}": "", "Configs {9f30b8a6} {ce073fe8}": "", "Configs {9f30b8a6} {fd43d59f}": "", "Configs {9f30b8a6} {3cf326fa}": "", "Configs {9f30b8a6} {907442e7}": "", "Configs {9f30b8a6} {fe1b406e}": "", "Configs {9f30b8a6} {d1f9fb6a}": "", "Configs {9f30b8a6} {54ccd262}": "", "Configs {9f30b8a6} {c29d06b9}": "", "Configs {9f30b8a6} {fa93507d}": "", "Configs {9f30b8a6} {ec211346}": "", "Configs {9f30b8a6} {7c29d4b9}": "", "Configs {9f30b8a6} {4e0d7b75}": "", "Configs {9f30b8a6} {40b0d0ff}": "", "Configs {9f30b8a6} {a7e2cc37}": "", "Configs {9f30b8a6} {a966473c}": "正悬赏信息", "Configs {9f30b8a6} ObjectiveBountyConfig": "战略点悬赏信息", "Configs {9f30b8a6} NegativeBountyConfig": "负悬赏信息", "Configs {1ff0e246} {5ba4ad0f}": "", "Configs {1ff0e246} {960dcbff}": "", "Configs {1ff0e246} {e999961a}": "", "Configs {1ff0e246} {f39f8571}": "", "Configs {1ff0e246} {d1e56ce4}": "", "Configs {1ff0e246} {f34f5793}": "", "Configs {90f7282b} {116cb40d}": "", "ConfigsClient {60e2ec74} LoadScreenTipConfiguration": "加载界面提示信息", "ConfigsClient {60e2ec74} LoadingScreenBackground": "加载界面背景", "ConfigsClient {60e2ec74} LoadingScreenBackgroundOverride": "加载界面背景重载", "ConfigsClient {60e2ec74} MutatorControlledLoadingScreenBackgrounds": "特殊模式加载界面背景", "ConfigsClient {85bf79cf} {07aa36d0}": "", "ConfigsClient {85bf79cf} {c5b58261}": "", "itemLists GameModeItemList mItems": "游戏模式装备目录", "mItemShopData ItemShopGameModeData RecOverrideSmiteStartingItems": "惩戒强制购买初始装备", "mItemShopData ItemShopGameModeData PurchasedItemExclusionItems": "不可购买的装备", "mItemShopData ItemShopGameModeData CompletedItems": "成装", "mItemShopData ItemShopGameModeData RecFallbackMapId": "推荐回退地图序号", "mItemShopData ItemShopGameModeData RecFallbackModeName": "推荐回退模式", "mItemShopData ItemShopGameModeData ConsumablesQuickBuyData": "消耗品", "mItemShopData ItemShopGameModeData BootsQuickBuyData": "鞋子", "mItemShopData ItemShopGameModeData RecItemsSwaps": "装备替换", "mItemShopData ItemShopGameModeData AllItemGroupDefinitionsOverride": "装备分组重定义信息", "mItemShopData ItemShopGameModeData RecRoleSwaps": "角色定位替换", "AnnouncementsMapping AnnouncementMap ParentList": "通告父级列表引用", "AnnouncementsMapping AnnouncementMap SpectatorOffsetRegion": "观战模式偏移区域", "AnnouncementsMapping AnnouncementMap DeathRecapOffsetRegion": "死亡回放偏移区域", "AnnouncementsMapping AnnouncementMap Announcements": "通告", "mStatsUiData GlobalStatsUIData mStatUIData": "基础属性", "mStatsUiData GlobalStatsUIData BaseOutputIconModifier": "基础属性图标修饰语", "mStatsUiData GlobalStatsUIData BonusOutputIconModifier": "额外属性图标修饰语", "mStatsUiData GlobalStatsUIData mNumberStyle": "属性数字格式", "mStatsUiData GlobalStatsUIData mNumberStylePercent": "属性数字百分比格式", "mStatsUiData GlobalStatsUIData mNumberStyleBonus": "额外属性数字格式", "mStatsUiData GlobalStatsUIData mNumberStyleBonusPercent": "额外属性数字百分比格式", "mStatsUiData GlobalStatsUIData FormulaPartStyleBonus": "额外属性公式格式", "mStatsUiData GlobalStatsUIData FormulaPartStyleBonusPercent": "额外属性百分比公式格式", "mStatsUiData GlobalStatsUIData FormulaPartStyle": "基础公式格式", "mStatsUiData GlobalStatsUIData FormulaPartStylePercent": "基础百分比属性格式", "mStatsUiData GlobalStatsUIData FormulaPartRangeStyleBonus": "公式额外属性范围格式", "mStatsUiData GlobalStatsUIData FormulaPartRangeStyleBonusPercent": "公式额外属性范围百分比格式", "mStatsUiData GlobalStatsUIData FormulaPartRangeStyle": "公式属性范围格式", "mStatsUiData GlobalStatsUIData FormulaPartRangeStylePercent": "公式属性范围百分比格式", "mStatsUiData GlobalStatsUIData mNumberStyleTotalAndCoefficient": "总和与系数数字格式", "mStatsUiData GlobalStatsUIData mNumberStyleTotalAndCoefficientPercent": "总和与系数百分比格式", "mStatsUiData GlobalStatsUIData NumberStyleTotalAndScalingIcons": "总和与缩放图标格式", "mStatsUiData GlobalStatsUIData NumberStyleTotalAndFormula": "总和与公式格式", "mStatsUiData GlobalStatsUIData mManaIconKey": "法力值图标键", "mStatsUiData GlobalStatsUIData mManaScalingTagKey": "法力值成长标签", "mStatsUiData GlobalStatsUIData mCharLevelScalingTagKey": "角色等级成长标签", "mStatsUiData GlobalStatsUIData CharLevelIconKey": "等级图标键", "mStatsUiData GlobalStatsUIData mTooltipCalculationExpansion": "说明文本展开级别", "mStatsUiData GlobalStatsUIData mExpandedTooltipCalculationExpansion": "扩展说明文本展开级别", "mStatsUiData GlobalStatsUIData NewStatUiData": "新版界面", "mExperienceCurveData ExperienceCurveData mExperienceRequiredPerLevel": "升级所需经验", "mExperienceCurveData ExperienceCurveData mExperienceGrantedForKillPerLevel": "击杀经验", "mExperienceCurveData ExperienceCurveData mExperienceGrantedMultForSharedKillPerLevel": "共享击杀经验倍率", "mExperienceCurveData ExperienceCurveData LevelDifferenceExperienceMultiplierPerLevel": "等级差异经验倍率", "mExperienceCurveData ExperienceCurveData mBaseExperienceMultiplier": "基础经验倍率", "mExperienceCurveData ExperienceCurveData mMinimumExperienceMultiplier": "最小经验倍率", "mExperienceCurveData ExperienceCurveData DefaultMaxLevel": "默认最大等级", "mExperienceModData ExperienceModData mPlayerMinionSplitXp": "小兵经验分配倍率", "mDeathTimes DeathTimes mTimeDeadPerLevel": "基础复活时间", "mDeathTimes DeathTimes mScalingStartTime": "游戏时长产生影响的时间", "mDeathTimes DeathTimes mScalingIncrementTime": "游戏时长缩放间隔", "mDeathTimes DeathTimes mScalingPercentIncrease": "游戏时长缩放百分比增量", "mDeathTimes DeathTimes mScalingPercentCap": "游戏时长缩放复活时间百分比上限", "mDeathTimes DeathTimes mScalingPoints": "游戏时长缩放节点", "mMapLocators MapLocatorArray locators": "地图物件位置矩阵", "mGameModeConstants GameModeConstants mGroups": "游戏模式常数分组", "mGameplayConfig GameplayConfig mAutoAttackMinPreCastLockoutDeltaTimeSec": "自动攻击前摇最小锁定时间", "mGameplayConfig GameplayConfig mAutoAttackMinPostCastLockoutDeltaTimeSec": "自动攻击后摇最小锁定时间", "mGameplayConfig GameplayConfig mLethalityPercentGivenAtLevel0": "初始护甲穿透", "mGameplayConfig GameplayConfig mLethalityScalesToLevel": "穿甲提升最大等级", "mGameplayConfig GameplayConfig mLethalityScalesCapsAtLevel": "穿甲计算等级上限", "mGameplayConfig GameplayConfig mLethalityRatioFromTarget": "来自目标的护甲穿透", "mGameplayConfig GameplayConfig mLethalityRatioFromAttacker": "来自攻击者的护甲穿透", "mGameplayConfig GameplayConfig AbilityHasteMax": "技能急速上限", "mGameplayConfig GameplayConfig mAdaptiveForceAbilityPowerScale": "适应之力转法术强度比例", "mGameplayConfig GameplayConfig mAdaptiveForceAttackDamageScale": "适应之力转攻击力比例", "mGameplayConfig GameplayConfig mMinionDeathDelay": "小兵死亡延迟", "mGameplayConfig GameplayConfig mMinionAutoLeeway": "小兵自动攻击容差", "mGameplayConfig GameplayConfig mMinionAAHelperLimit": "小兵攻击辅助距离限制", "mGameplayConfig GameplayConfig mItemSellQueueTime": "装备出售队列时间", "mGameplayConfig GameplayConfig ExtendedVisibilityDuration": "视野延续时间", "mGameplayConfig GameplayConfig mCCScoreMultipliers": "控制得分计分方式", "mGameplayConfig GameplayConfig mSummonerSpells": "召唤师技能", "mGameplayConfig GameplayConfig mLegacySummonerSpells": "传统召唤师技能", "mGameplayConfig GameplayConfig mBasicAttackCalculation": "普通伤害计算方式", "mGameplayConfig GameplayConfig mPerkRootSpellOrigination": "符文效果相关文件", "mGameplayConfig GameplayConfig mItemRootSpellOrigination": "装备效果相关文件", "mSurrenderSettings SurrenderData {4987e889}": "", "mSurrenderSettings SurrenderData {d9d17df4}": "允许重开时间", "mSurrenderSettings SurrenderData mMinAfkTimeForNoVote": "挂机玩家剥夺投票权时间", "mSurrenderSettings SurrenderData FountainDetectionDurationSecs": "泉水检测持续时间", "mSurrenderSettings SurrenderData mTypeData": "投降具体数据", "mSurrenderSettings SurrenderData TimeInactiveForEarlySurrenderSecs": "允许提前投降时间", "mSurrenderSettings SurrenderData mMinTimeBetweenSurrenders": "最小投降间隔时间", "mAutoItemPurchasingConfig GameModeAutoItemPurchasingConfig mMaxPurchaseAttemptsPerSession": "自动购买最大尝试次数", "mAutoItemPurchasingConfig GameModeAutoItemPurchasingConfig mSequentiallyPurchasedRecItemBlockTypes": "顺序购买的推荐装备类型", "mAutoItemPurchasingConfig GameModeAutoItemPurchasingConfig mRandomlyPurchasedRecItemBlockTypes": "随机购买的推荐装备类型", "mAutoItemPurchasingConfig GameModeAutoItemPurchasingConfig mSituationalPurchasedRecItemBlockTypes": "情境购买的推荐装备类型", "mAutoItemPurchasingConfig GameModeAutoItemPurchasingConfig mItemGroupToAvoidSellingAndSetCostCeiling": "无法出售且设置价格上限的推荐装备类型", "Configs {4a0e85bf} {38ad90f3}": "", "Configs {4a0e85bf} {bc94aba4}": "", "Configs {92309121} {8eb174a9}": "", "Configs {92309121} {9c8d113e}": "", "Configs {92309121} {17659fc6}": "", "Configs {92309121} {20fc97e7}": "", "Configs {92309121} {83f73f14}": "", "Configs {92309121} {8fcc8a74}": "", "Configs {92309121} {30b50544}": "", "Configs {92309121} {bc9ba03a}": "", "Configs {92309121} {4fb25d9f}": "", "Configs {92309121} {4721facd}": "", "Configs {92309121} {02253423}": "", "Configs {92309121} {51274048}": "", "Configs {92309121} {52d1e5c3}": "", "Configs {92309121} {433be97f}": "", "Configs {92309121} {6df5dc15}": "", "Configs {92309121} {d7396d73}": "", "Configs {92309121} {1e88b9d4}": "", "Configs {5a92b195} {68d95a00}": "", "Configs {5a92b195} {911d1120}": "", "ConfigsClient ScoreboardGameModeConfig ScoreboardTeamScoreTypes": "计分类型", "ConfigsClient ScoreboardGameModeConfig {c72e2257}": "", "ConfigsClient ScoreboardGameModeConfig {7ed80272}": "", "ConfigsClient {c3a44766} {a86fc2ef}": "", "ConfigsClient {c3a44766} {95823356}": "", "ConfigsClient {c3a44766} {22728a51}": "", "ConfigsClient {c3a44766} {ed23ad91}": "", "ConfigsClient {c3a44766} {eb6c72dd}": "", "ConfigsClient {c3a44766} {44735f30}": "", "ConfigsClient {e348122d} {f2c97a22}": "", "ConfigsClient {e348122d} {5c333500}": "", "JungleRecommendationMapInformation JungleRecommendationMapInformation JungleLocationInformation": "野怪位置参数", "DefaultJunglePathRecommendation JunglePathRecommendation OrderJunglePath": "蓝方推荐打野路线", "DefaultJunglePathRecommendation JunglePathRecommendation ChaosJunglePath": "红方推荐打野路线", "DefaultRespawnPoints RespawnPointDataList RespawnPoints": "重生位置", "LevelControllers BehaviorLevelController Guid": "行为动作识别码", "LevelControllers BehaviorLevelController LevelBehaviors": "行为动作参数", "Configs {df6e7fa5} {a3627eca}": "", "Configs {5858e503} {8a68bc86}": "末日人工智能配置名称", "Configs {5858e503} EventLists": "末日人工智能事件列表", "Configs {9a722730} {146b3900}": "", "mChampionLists GameModeChampionList mChampions": "游戏模式限定英雄列表", "{dc2bc473} GameModeItemList mItems": "游戏模式特殊装备列表", "Configs AdditionalMapContainersConfig MapContainers": "子地图", "Configs {409a5657} {8794a0e6}": "强化符文边框颜色配置方案", "Configs {409a5657} {ba9783c7}": "", "Configs {e8c34b52} AugmentColors": "强化符文卡颜色", "Configs {e8c34b52} EliminatedColor": "强化符文淘汰显示颜色", "Configs {e8c34b52} {f021feb3}": "", "mStatsUiData GlobalStatsUIData BaseOutputIconModifier string": "基础属性图标修饰语字符串", "mStatsUiData GlobalStatsUIData BonusOutputIconModifier string": "额外属性图标修饰语字符串", "mStatsUiData GlobalStatsUIData mNumberStyle string": "属性数字格式字符串", "mStatsUiData GlobalStatsUIData mNumberStylePercent string": "属性数字百分比格式字符串", "mStatsUiData GlobalStatsUIData mNumberStyleBonus string": "额外属性数字格式字符串", "mStatsUiData GlobalStatsUIData mNumberStyleBonusPercent string": "额外属性数字百分比格式字符串", "mStatsUiData GlobalStatsUIData FormulaPartStyleBonus string": "额外属性公式格式字符串", "mStatsUiData GlobalStatsUIData FormulaPartStyleBonusPercent string": "额外属性百分比公式格式字符串", "mStatsUiData GlobalStatsUIData FormulaPartStyle string": "基础公式格式字符串", "mStatsUiData GlobalStatsUIData FormulaPartStylePercent string": "基础百分比属性格式字符串", "mStatsUiData GlobalStatsUIData FormulaPartRangeStyleBonus string": "公式额外属性范围格式字符串", "mStatsUiData GlobalStatsUIData FormulaPartRangeStyleBonusPercent string": "公式额外属性范围百分比格式字符串", "mStatsUiData GlobalStatsUIData FormulaPartRangeStyle string": "公式属性范围格式字符串", "mStatsUiData GlobalStatsUIData FormulaPartRangeStylePercent string": "公式属性范围百分比格式字符串", "mStatsUiData GlobalStatsUIData mNumberStyleTotalAndCoefficient string": "总和与系数数字格式字符串", "mStatsUiData GlobalStatsUIData mNumberStyleTotalAndCoefficientPercent string": "总和与系数百分比格式字符串", "mStatsUiData GlobalStatsUIData NumberStyleTotalAndScalingIcons string": "总和与缩放图标格式字符串", "mStatsUiData GlobalStatsUIData NumberStyleTotalAndFormula string": "总和与公式格式字符串"}
...
class CheatExtractor(LoLDataExtractor):
    ...
    def build_cheat_dataframe(self, debug: bool = False, path: Optional[str] = None) -> int:
        ...
        #定义数据结构（Define the data structure）
        cheatset_header: dict[str, str] = {"key": "主键", "mName": "代码", "mIsPlayerFacing": "可见性", "mGameModeName": "游戏模式", "mGameMutator": "子模式", "AssociatedChampions": "相关英雄", "{bd50bdef}": "指令列表", "mIsUIAlwaysShown": "总是呈现"}
        ...
        cheat_header: dict[str, str] = {"key": "主键", "mName": "代码", "mIsPlayerFacing": "可见性", "mRecastFrequency": "施法频率", "mTarget": "作用目标", "UseTargetAsCaster": "目标作为施法者", "UseTargetAsSource": "目标作为来源", "mTimerValue": "计时器取值", "mDamageAmount": "伤害数额（百分比）", "mScriptCallback": "调用方法", "{30ce16ae}": "作用野怪类型", "mKillExistingMinions": "击杀存活小兵", "mKillWards": "摧毁守卫", "mStartingItemIds": "起始装备序号列表", "mGoldAmount": "金币数额", "mFlags": "旗标", "mTeam": "阵营代号", "mPlayerName": "玩家代码", "mMinionName": "小兵代码", "mCharacterName": "角色名称", "mAmount": "数额", "mSpeedDown": "减速", "mSpeedUp": "加速", "ResetToBaseSpeed": "重置为基础移动速度", "MoveDelta": "移动速度增量", "mToggleHP": "启用/禁用生命回复", "mTogglePAR": "启用/禁用施法资源回复", "mGiveMaxLevel": "提供最大等级", "mOnlyOnePointEach": "即点即杀", "__type": "对象数据类型", "mDisplayName": "显示名", "mFloatingTextDisplayName": "标题键", "mTooltipText": "说明键", "mDynamicTooltipText": "详细信息键", "mHotkey": "快捷键代码", "mHotkeys": "可用快捷键代码", "mIsToggleCheat": "开关型", "mCheatMenuUIDataType": "指令菜单数据类型", "mFloatingTextDisplayName_content_zh": "标题（中文）", "mFloatingTextDisplayName_content_en": "标题（英文）", "mTooltipText_content_zh": "说明（中文）", "mTooltipText_content_en": "说明（英文）", "mDynamicTooltipText_content_zh": "详细信息（中文）", "mDynamicTooltipText_content_en": "详细信息（英文）", "belonging_cheatset_mName": "所属指令集代码"}
...
class PerkExtractor(LoLDataExtractor):
    ...
    def build_perk_dataframe(self, debug: bool = False, path: Optional[str] = None) -> int:
        ...
        ##符文系（Perkstyle）
        perkstyle_header: dict[str, str] = {"key": "主键", "mPerkStyleId": "符文系序号", "mPerkStyleName": "符文系代码", "mDisplayNameLocalizationKey": "显示名键", "mTooltipNameLocalizationKey": "简介键", "mDefaultPageLocalizationKey": "默认符文页名称键", "mIconTextureName": "图标纹理名称", "mIsAdvancedStyle": "高级符文系", "mAllowedSubStyles": "可用副系序号", "mSubStyleBonus": "副系加成", "mDefaultSplash mStyle": "默认插画符文系", "mDefaultSplash mPerk1": "默认插画符文1", "mDefaultSplash mPerk2": "默认插画符文2", "mDefaultPerksWhenSplashed": "渲染插画时默认使用符文", "mDefaultStatModsPerSubStyle": "搭配各副系时的默认属性符文", "mSlots": "槽位", "mSlotlinks": "槽位主键", "mScript mSpellScriptName": "指令名称", "mScript mSpellScriptData": "指令数据", "mScriptAsSubStyle": "用作副系时的指令", "mStyleVFXResourceResolver resourceMap": "视觉效果资源解析器映射字典", "mDisplayNameLocalizationKey_content_zh": "显示名（中文）", "mDisplayNameLocalizationKey_content_en": "显示名（英文）", "mTooltipNameLocalizationKey_content_zh": "简介（中文）", "mTooltipNameLocalizationKey_content_en": "简介（英文）", "mDefaultPageLocalizationKey_content_zh": "默认符文页名称（中文）", "mDefaultPageLocalizationKey_content_en": "默认符文页名称（英文）", "mAllowedSubStyles mDisplayNameLocalizationKey_contents_zh": "可用副系名称（中文）", "mAllowedSubStyles mDisplayNameLocalizationKey_contents_en": "可用副系名称（英文）", "mDefaultPerksWhenSplashed mDisplayNameLocalizationKey_contents_zh": "渲染插画时默认使用符文名称（中文）", "mDefaultPerksWhenSplashed mDisplayNameLocalizationKey_contents_en": "渲染插画时默认使用符文名称（英文）", "mDefaultStatModsPerSubStyle1 mStyleId": "搭配各副系时的默认属性符文：副系1序号", "mDefaultStatModsPerSubStyle1 mPerks": "搭配各副系时的默认属性符文：副系1属性符文", "mDefaultStatModsPerSubStyle1 mStyle mDisplayNameLocalizationKey_content_zh": "搭配各副系时的默认属性符文：副系1名称（中文）", "mDefaultStatModsPerSubStyle1 mStyle mDisplayNameLocalizationKey_content_en": "搭配各副系时的默认属性符文：副系1名称（英文）", "mDefaultStatModsPerSubStyle1 mPerks mDisplayNameLocalizationKey_contents_zh": "搭配各副系时的默认属性符文：副系1属性符文名称（中文）", "mDefaultStatModsPerSubStyle1 mPerks mDisplayNameLocalizationKey_contents_en": "搭配各副系时的默认属性符文：副系1属性符文名称（英文）", "mDefaultStatModsPerSubStyle2 mStyleId": "搭配各副系时的默认属性符文：副系2序号", "mDefaultStatModsPerSubStyle2 mPerks": "搭配各副系时的默认属性符文：副系2属性符文", "mDefaultStatModsPerSubStyle2 mStyle mDisplayNameLocalizationKey_content_zh": "搭配各副系时的默认属性符文：副系2名称（中文）", "mDefaultStatModsPerSubStyle2 mStyle mDisplayNameLocalizationKey_content_en": "搭配各副系时的默认属性符文：副系2名称（英文）", "mDefaultStatModsPerSubStyle2 mPerks mDisplayNameLocalizationKey_contents_zh": "搭配各副系时的默认属性符文：副系2属性符文名称（中文）", "mDefaultStatModsPerSubStyle2 mPerks mDisplayNameLocalizationKey_contents_en": "搭配各副系时的默认属性符文：副系2属性符文名称（英文）", "mDefaultStatModsPerSubStyle3 mStyleId": "搭配各副系时的默认属性符文：副系3序号", "mDefaultStatModsPerSubStyle3 mPerks": "搭配各副系时的默认属性符文：副系3属性符文", "mDefaultStatModsPerSubStyle3 mStyle mDisplayNameLocalizationKey_content_zh": "搭配各副系时的默认属性符文：副系3名称（中文）", "mDefaultStatModsPerSubStyle3 mStyle mDisplayNameLocalizationKey_content_en": "搭配各副系时的默认属性符文：副系3名称（英文）", "mDefaultStatModsPerSubStyle3 mPerks mDisplayNameLocalizationKey_contents_zh": "搭配各副系时的默认属性符文：副系3属性符文名称（中文）", "mDefaultStatModsPerSubStyle3 mPerks mDisplayNameLocalizationKey_contents_en": "搭配各副系时的默认属性符文：副系3属性符文名称（英文）", "mDefaultStatModsPerSubStyle4 mStyleId": "搭配各副系时的默认属性符文：副系4序号", "mDefaultStatModsPerSubStyle4 mPerks": "搭配各副系时的默认属性符文：副系4属性符文", "mDefaultStatModsPerSubStyle4 mStyle mDisplayNameLocalizationKey_content_zh": "搭配各副系时的默认属性符文：副系4名称（中文）", "mDefaultStatModsPerSubStyle4 mStyle mDisplayNameLocalizationKey_content_en": "搭配各副系时的默认属性符文：副系4名称（英文）", "mDefaultStatModsPerSubStyle4 mPerks mDisplayNameLocalizationKey_contents_zh": "搭配各副系时的默认属性符文：副系4属性符文名称（中文）", "mDefaultStatModsPerSubStyle4 mPerks mDisplayNameLocalizationKey_contents_en": "搭配各副系时的默认属性符文：副系4属性符文名称（英文）", "mSlot1 mSlotLabelKey": "槽位1：标签键", "mSlot1 mType": "槽位1：类型", "mSlot1 mPerks": "槽位1：符文", "mSlot1 mSlotLabelKey_content_zh": "槽位1：标签（中文）", "mSlot1 mSlotLabelKey_content_en": "槽位1：标签（英文）", "mSlot1 mPerks mDisplayNameLocalizationKey_contents_zh": "槽位1：符文显示名（中文）", "mSlot1 mPerks mDisplayNameLocalizationKey_contents_en": "槽位1：符文显示名（英文）", "mSlot2 mSlotLabelKey": "槽位2：标签键", "mSlot2 mType": "槽位2：类型", "mSlot2 mPerks": "槽位2：符文", "mSlot2 mSlotLabelKey_content_zh": "槽位2：标签（中文）", "mSlot2 mSlotLabelKey_content_en": "槽位2：标签（英文）", "mSlot2 mPerks mDisplayNameLocalizationKey_contents_zh": "槽位2：符文显示名（中文）", "mSlot2 mPerks mDisplayNameLocalizationKey_contents_en": "槽位2：符文显示名（英文）", "mSlot3 mSlotLabelKey": "槽位3：标签键", "mSlot3 mType": "槽位3：类型", "mSlot3 mPerks": "槽位3：符文", "mSlot3 mSlotLabelKey_content_zh": "槽位3：标签（中文）", "mSlot3 mSlotLabelKey_content_en": "槽位3：标签（英文）", "mSlot3 mPerks mDisplayNameLocalizationKey_contents_zh": "槽位3：符文显示名（中文）", "mSlot3 mPerks mDisplayNameLocalizationKey_contents_en": "槽位3：符文显示名（英文）", "mSlot4 mSlotLabelKey": "槽位4：标签键", "mSlot4 mType": "槽位4：类型", "mSlot4 mPerks": "槽位4：符文", "mSlot4 mSlotLabelKey_content_zh": "槽位4：标签（中文）", "mSlot4 mSlotLabelKey_content_en": "槽位4：标签（英文）", "mSlot4 mPerks mDisplayNameLocalizationKey_contents_zh": "槽位4：符文显示名（中文）", "mSlot4 mPerks mDisplayNameLocalizationKey_contents_en": "槽位4：符文显示名（英文）", "mSlotlinks mSlotLabelKey_contents_zh": "槽位标签（中文）", "mSlotlinks mSlotLabelKey_contents_en": "槽位标签（英文）"}
        ...
        ##符文（Perk）
        perk_header: dict[str, str] = {"key": "主键", "mPerkId": "符文序号", "mPerkName": "符文代码", "mDisplayNameLocalizationKey": "显示名键", "mTooltipNameLocalizationKey": "简介键", "mPingTextLocalizationKey": "标记文本键", "mShortDescLocalizationKey": "简述键", "mLongDescLocalizationKey": "详细信息键", "mEndOfGameStatDescriptions": "赛后结算描述键", "mDisplayStatLocalizationKey": "显示属性定位键", "mIconTextureName": "图标纹理名称", "mStackable": "可叠加", "mEnabled": "可用性", "mScript mSpellScriptName": "指令名称", "mScript mSpellScriptData": "指令数据", "mBuffs": "增益信息", "mVFXResourceResolver resourceMap": "视觉效果资源解析器映射字典", "mSummonerPerkReplacements mReplacements": "召唤师符文替换", "mDefault": "默认符文", "mCharacters": "相关角色", "mMajorChangePatchVersion": "主要变更版本号", "mDisplayNameLocalizationKey_content_zh": "显示名（中文）", "mDisplayNameLocalizationKey_content_en": "显示名（英文）", "mTooltipNameLocalizationKey_content_zh": "简介（中文）", "mTooltipNameLocalizationKey_content_en": "简介（英文）", "mTooltipNameLocalizationKey_content_zh_burn": "简介（中文/数值转换）", "mTooltipNameLocalizationKey_content_en_burn": "简介（英文/数值转换）", "mPingTextLocalizationKey_content_zh": "标记文本（中文）", "mPingTextLocalizationKey_content_en": "标记文本（英文）", "mShortDescLocalizationKey_content_zh": "简述（中文）", "mShortDescLocalizationKey_content_en": "简述（英文）", "mShortDescLocalizationKey_content_zh_burn": "简述（中文/数值转换）", "mShortDescLocalizationKey_content_en_burn": "简述（英文/数值转换）", "mLongDescLocalizationKey_content_zh": "详细信息（中文）", "mLongDescLocalizationKey_content_en": "详细信息（英文）", "mLongDescLocalizationKey_content_zh_burn": "详细信息（中文/数值转换）", "mLongDescLocalizationKey_content_en_burn": "详细信息（英文/数值转换）", "mEndOfGameStatDescriptions_contents_zh": "赛后结算描述（中文）", "mEndOfGameStatDescriptions_contents_en": "赛后结算描述（英文）"}
...
class ChampionExtractor(LoLDataExtractor):
    ...
    def build_champion_dataframe(self, useAllCharacter: Optional[bool] = None, debug: bool = False, paths: Optional[list[str]] = None) -> int:
        ...
        champion_header: dict[str, str] = {"key": "主键", "modeFolder": "游戏模式文件夹", "mCharacterName": "角色名称", "mFallbackCharacterName": "备用名称", "PackmanagerData": "跟随者数据", "{dd661aab}": "冲刺配置", "evolutionData": "技能进化数据", "useableData": "可用数据", "baseHP": "基础生命值", "hpPerLevel": "成长生命值", "baseStaticHPRegen": "基础生命回复", "hpRegenPerLevel": "生命回复成长", "highlightHealthbarIcons": "高亮生命槽", "healthBarHeight": "血条高度", "selfChampSpecificHealthSuffix": "己方视角下的英雄生命槽颜色", "selfCBChampSpecificHealthSuffix": "己方色盲视角下的英雄生命槽颜色", "allyChampSpecificHealthSuffix": "友方视角下的英雄生命槽颜色", "enemyChampSpecificHealthSuffix": "敌方视角下的英雄生命槽颜色", "healthBarFullParallax": "生命槽使用完整视差效果", "primaryAbilityResource": "主要施法资源", "secondaryAbilityResource": "次要施法资源", "baseDamage": "基础攻击力", "damagePerLevel": "成长攻击力", "baseArmor": "基础护甲", "armorPerLevel": "成长护甲", "critPerLevel": "成长暴击几率", "baseSpellBlock": "基础魔法抗性", "baseCritChance": "基础暴击几率", "spellBlockPerLevel": "成长魔法抗性", "critDamageMultiplier": "暴击伤害修正率", "baseMoveSpeed": "基础移动速度", "RotationSmoothing": "模型旋转平滑度", "attackRange": "攻击距离", "attackSpeed": "基础攻击速度", "attackSpeedRatio": "攻击速度收益率", "attackSpeedPerLevel": "成长攻击速度", "TreatAutoAttacksAsNormalSpells": "自动攻击视为技能配置", "mAdaptiveForceToAbilityPowerWeight": "适应之力转法强比例", "acquisitionRange": "索敌范围半径", "basicAttack": "普通攻击动作参数", "extraAttacks": "其它攻击动作参数", "critAttacks": "暴击动作参数", "expGivenOnDeath": "阵亡时获取经验值", "goldGivenOnDeath": "阵亡时获取金币", "deathEventListeningRadius": "死亡事件监听范围半径", "spellNames": "技能指令名称列表", "spells": "技能指令代码列表", "extraSpells": "其它指令代码列表", "{c1984296}": "更多指令代码列表", "mAbilities": "技能键列表", "criticalAttack": "暴击指令键", "passiveName": "被动技能名称键", "passiveLuaName": "被动技能脚本名", "passiveToolTip": "被动技能描述文本键", "passiveRange": "被动技能范围", "passiveSpell": "被动技能指令代码", "passive1IconName": "被动技能图标1路径", "perceptionBubbleRadius": "感知气泡半径", "significance": "选取优先级系数", "friendlyTooltip": "友军说明文本键", "enemyTooltip": "敌军说明文本键", "minimapIconOverride": "小地图图标重载名称", "name": "显示名键", "silhouetteAttachmentAnim": "附身轮廓动画名称", "parName": "次要施法资源名称键", "weaponMaterials": "武器材料", "outlineBBoxExpansion": "轮廓扩展半径", "charAudioNameOverride": "英雄语音覆盖代码", "mUseCCAnimations": "移动受损动画已激活", "selectionHeight": "鼠标指针选择高度", "selectionRadius": "鼠标指针选择半径", "pathfindingCollisionRadius": "寻路碰撞体积半径", "overrideGameplayCollisionRadius": "特定条件覆盖碰撞体积半径", "unitTagsString": "单位类型标签字符串", "friendlyUxOverrideTeam": "友方界面队伍取值", "friendlyUxOverrideIncludeTagsString": "友方界面队伍包含字符串", "friendlyUxOverrideExcludeTagsString": "友方界面队伍不包含字符串", "mEducationToolData": "教程配置", "mAbilitySlotCC": "技能槽位控制效果分类变量", "characterToolData": "英雄说明", "platformEnabled": "大区可用性", "spellLevelUpInfo": "技能升级信息", "RecSpellRankUpInfolist": "推荐技能加点顺序列表", "useRiotRelationships": "采用新版设计理念", "flags": "旗标", "purchaseIdentities": "购买装备具备特质", "mPreferredPerkStyle": "推荐符文主系", "mCharacterCalculations": "英雄数据计算", "mPerkReplacements": "符文替换信息", "mCharacterPassiveSpell": "被动技能指令键", "mCharacterPassiveBuffs": "被动技能增益信息", "{6854087e}": "游戏模式数据覆盖", "{c5c48b41}": "", "tier": "卡费（仅云顶之弈）", "NumToCombine": "升星所需单位数量（仅云顶之弈）", "BoardCountContribution": "占用出战单位数（仅云顶之弈）", "mLinkedTraits": "相关羁绊信息（仅云顶之弈）", "CharacterRole": "角色定位（仅云顶之弈）", "mMoveInterval": "移动间隔（秒）（仅云顶之弈）", "mMoveProximity": "单次移动接近距离阈值（仅云顶之弈）", "mMoveRange": "单次移动范围半径（仅云顶之弈）", "mMoveHeight": "单次移动高度（仅云顶之弈）", "mInitialMana": "初始法力值（仅云顶之弈）", "mShopData": "购物信息（仅云顶之弈）", "{184999c3}": "", "mIsDiscoverable": "供应池可见性（仅云顶之弈）", "{fe0d6477}": "", "mUnitInfoCardAttachToBone": "单位信息卡片附着点（仅云顶之弈）", "mUnitInfoCardWorldOffset": "单位信息卡片显示位置偏移量（仅云顶之弈）", "UnitInfoCardDisplayType": "单位信息卡片显示类型（仅云顶之弈）", "MobileHealthBarHeightOverride": "移动端血条高度覆盖值（仅云顶之弈）", "mUsesAbilityPower": "使用法术强度（仅云顶之弈）", "OmitFromCombatRecap": "从战斗回放中省略（仅云顶之弈）", "OmitFromMatchHistory": "从对局记录中省略（仅云顶之弈）", "LinkedUnits": "相关单位（仅云顶之弈）", "ShowItemsUnsorted": "按随机顺序显示（仅云顶之弈）", "mManaPerAttack": "每次攻击回复法力值（仅云顶之弈）", "{f94987a3}": "", "passiveObject": "被动技能指令对象", "spell1Object": "技能1指令对象", "spell2Object": "技能2指令对象", "spell3Object": "技能3指令对象", "spell4Object": "技能4指令对象", "passiveName_content_zh": "被动技能名称（中文）", "passiveName_content_en": "被动技能名称（英文）", "passiveToolTip_content_zh": "被动技能说明文本（中文）", "passiveToolTip_content_en": "被动技能说明文本（英文）", "passiveToolTip_content_zh_burn": "被动技能说明文本（中文/数值转换）", "passiveToolTip_content_en_burn": "被动技能说明文本（英文/数值转换）", "friendlyTooltip_content_zh": "友军说明文本（中文）", "friendlyTooltip_content_en": "友军说明文本（英文）", "enemyTooltip_content_zh": "敌军说明文本（中文）", "enemyTooltip_content_en": "敌军说明文本（英文）", "name_content_zh": "显示名（中文）", "name_content_en": "显示名（英文）", "parName_content_zh": "次要施法资源名称（中文）", "parName_content_en": "次要施法资源名称（英文）", "spellNames_content_zh": "技能名称（中文）", "spellNames_content_en": "技能名称（英文）", "CharacterRoleNameTra_content_zh": "角色定位（中文）（仅云顶之弈）", "CharacterRoleNameTra_content_en": "角色定位（英文）（仅云顶之弈）", "ShopDataObject": "购物数据对象（仅云顶之弈）", "mLinkedTraits TraitData mDisplayNameTra_content_zh": "相关羁绊名称（中文）（仅云顶之弈）", "mLinkedTraits TraitData mDisplayNameTra_content_en": "相关羁绊名称（英文）（仅云顶之弈）", "baseHPModifiable baseValue": "基础生命值", "hpPerLevelModifiable baseValue": "成长生命值", "baseStaticHPRegenModifiable baseValue": "基础生命回复", "hpRegenPerLevelModifiable baseValue": "生命回复成长", "baseDamageModifiable baseValue": "基础攻击力", "damagePerLevelModifiable baseValue": "成长攻击力", "baseArmorModifiable baseValue": "基础护甲", "armorPerLevelModifiable baseValue": "成长护甲", "baseMR baseValue": "基础魔法抗性", "{01262a25} baseValue": "成长魔法抗性", "baseMoveSpeedModifiable baseValue": "基础移动速度", "attackRangeModifiable baseValue": "攻击距离", "attackSpeedModifiable baseValue": "基础攻击速度", "attackSpeedRatioModifiable baseValue": "攻击速度收益率", "attackSpeedPerLevelModifiable baseValue": "成长攻击速度", "PackmanagerData BuffOverrides": "跟随者特殊处理增益", "PackmanagerData FollowerCrossoverAnimation": "跟随者更换移动指令动画名称", "PackmanagerData OnLeaderMoveFollowerAnimation": "英雄移动时跟随动画名称", "PackmanagerData OrderTrailingDelay": "跟随者接受指令延迟", "PackmanagerData LeashDistance": "跟随距离限制", "PackmanagerData UiTargetForgivenessRange": "用户选中跟随者宽限范围", "PackmanagerData AttackMoveTargetForgivenessRange": "攻击移动目标宽限范围", "PackmanagerData {b97a9b92}": "", "PackmanagerData {377491e8}": "", "PackmanagerData {377491e8} minDistance": "", "PackmanagerData {377491e8} maxDistance": "", "PackmanagerData {377491e8} {7863785e}": "", "PackmanagerData RankToFormationMap": "跟随者相对英雄位置坐标映射", "evolutionData mFlags": "技能进化旗标", "evolutionData mTitle": "技能进化标题键", "evolutionData mTooltips": "技能进化说明文本列表", "evolutionData mIconNames": "技能进化图标路径列表", "evolutionData mTitle_content_zh": "技能进化标题（中文）", "evolutionData mTitle_content_en": "技能进化标题（英文）", "evolutionData mTooltips_content_zh": "技能进化说明文本（中文）", "evolutionData mTooltips_content_en": "技能进化说明文本（英文）", "evolutionData mTooltips_content_zh_burn": "技能进化说明文本（中文/数值转换）", "evolutionData mTooltips_content_en_burn": "技能进化说明文本（英文/数值转换）", "UseableData flags": "可用数据：旗标", "UseableData useHeroSpellName": "使用英雄技能名称", "UseableData useSpellName": "使用法术名称", "UseableData useCooldownSpellSlot": "使用冷却时间的技能槽位", "primaryAbilityResource arType": "主要施法资源类型", "primaryAbilityResource arBase": "主要施法资源基础属性", "primaryAbilityResource arPerLevel": "主要施法资源成长属性", "primaryAbilityResource arBaseStaticRegen": "主要施法资源回复", "primaryAbilityResource arRegenPerLevel": "主要施法资源回复成长属性", "primaryAbilityResource arIncrements": "主要施法资源增量", "primaryAbilityResource arMaxSegments": "主要施法资源最大层数", "primaryAbilityResource arHasRegenText": "主要施法资源显示充能文本", "primaryAbilityResource arDisplayAsPips": "主要施法资源以充能点显示", "primaryAbilityResource arAllowMaxValueToBeOverridden": "主要施法资源最大值可变", "primaryAbilityResource arIsShown": "主要施法资源可见性", "primaryAbilityResource {4eb6a404}": "", "primaryAbilityResource {726ee5cd} baseValue": "主要施法资源基础属性", "primaryAbilityResource {6216bf7b} baseValue": "主要施法资源成长属性", "primaryAbilityResource baseValue baseValue": "主要施法资源回复", "primaryAbilityResource {3a509002} baseValue": "主要施法资源回复成长属性", "secondaryAbilityResource arType": "次要施法资源类型", "secondaryAbilityResource arBase": "次要施法资源基础属性", "secondaryAbilityResource arPerLevel": "次要施法资源成长属性", "secondaryAbilityResource arBaseStaticRegen": "次要施法资源回复", "secondaryAbilityResource arIncrements": "次要施法资源增量", "secondaryAbilityResource arMaxSegments": "次要施法资源最大层数", "secondaryAbilityResource arHasRegenText": "次要施法资源显示充能文本", "secondaryAbilityResource arDisplayAsPips": "次要施法资源以充能点显示", "secondaryAbilityResource arOverrideSmallPipName": "次要施法资源重载小充能点名称", "secondaryAbilityResource arOverrideMediumPipName": "次要施法资源重载中充能点名称", "secondaryAbilityResource arOverrideLargePipName": "次要施法资源重载大充能点名称", "secondaryAbilityResource arOverrideEmptyPipName": "次要施法资源重载空充能点名称", "secondaryAbilityResource arOverrideSpacerName": "次要施法资源重载充能格名称", "secondaryAbilityResource arNegativeSpacer": "次要施法资源反向充能", "secondaryAbilityResource HideEmptyPips": "次要施法资源隐藏空充能点", "secondaryAbilityResource arAllowMaxValueToBeOverridden": "次要施法资源最大值可变", "secondaryAbilityResource arIsShown": "次要施法资源可见性", "secondaryAbilityResource VisibilityFlags": "次要施法资源可见性旗标", "secondaryAbilityResource {4eb6a404}": "", "secondaryAbilityResource {726ee5cd} baseValue": "次要施法资源基础属性", "secondaryAbilityResource {6216bf7b} baseValue": "次要施法资源成长属性", "secondaryAbilityResource baseValue baseValue": "次要施法资源回复", "basicAttack mAttackTotalTime": "普通攻击动画总时间", "basicAttack mAttackCastTime": "普通攻击前摇窗口", "basicAttack mOverrideAutoattackCastTime": "自动攻击前摇窗口变化", "basicAttack mAttackDelayCastOffsetPercent": "投射物发出相对于普通攻击的偏差时间百分比", "basicAttack mAttackDelayCastOffsetPercentAttackSpeedRatio": "投射物发出相对于普通攻击的偏差时间百分比与攻击速度的比值", "basicAttack mAttackProbability": "普通攻击动画触发概率", "basicAttack mAttackName": "普通攻击事件名称", "mEducationToolData firstItem": "出门装推荐", "mEducationToolData skillOrder": "技能加点顺序", "characterToolData recItems": "推荐装备序号列表", "characterToolData TutorialRecItems": "新手教程推荐装备序号列表", "characterToolData sound": "音效方案", "characterToolData spellData": "技能指令元数据", "characterToolData weaponMaterialCrit": "武器暴击指令名称", "characterToolData mapAIPresence": "AI模型可用性", "characterToolData passLev1Desc": "被动等级描述", "characterToolData passiveData": "被动数据", "characterToolData alternateForms": "其它形态", "characterToolData searchTags": "检索标签：主要职业", "characterToolData searchTagsSecondary": "检索标签：次要职业", "characterToolData championId": "英雄序号", "characterToolData roles": "角色定位", "characterToolData PARFadeColor": "被动资源渐变色", "characterToolData PostAttackMoveDelay": "攻击后移动延迟", "characterToolData magicRank": "技能风格", "characterToolData Lore2": "背景故事", "characterToolData LevelSpellEffectiveness": "技能升级效应因子", "characterToolData difficultyRank": "使用难度", "characterToolData description": "描述键", "characterToolData defenseRank": "强韧风格", "characterToolData classification": "分类", "characterToolData ChasingAttackRangePercent": "追击移动攻击距离百分比", "characterToolData botEnabled": "电脑模型可用性", "characterToolData botEnabledMM": "电脑模型匹配对局可用性", "characterToolData {aa75da9d}": "", "characterToolData attackSpeed": "攻击速度上限", "characterToolData botDefaultSpell1": "电脑玩家默认携带召唤师技能1", "characterToolData botDefaultSpell2": "电脑玩家默认携带召唤师技能2", "characterToolData attackRank": "普攻风格", "characterToolData sound attack": "攻击音效列表", "characterToolData sound click": "单击音效列表", "characterToolData sound move": "移动音效列表", "characterToolData sound death": "阵亡音效", "characterToolData sound ready": "就绪音效", "characterToolData description_content_zh": "描述（中文）", "characterToolData description_content_en": "描述（英文）"}
        ...
        champion_spell_header: dict[str, str] = {"key": "主键", "championFolder": "英雄文件夹", "isRootSpell": "根技能", "rootAbility_key": "所属技能键", "rootAbility_mRootSpell": "所属技能的基本指令", "rootAbility_mChildSpells": "所属技能的附带指令", "rootAbility_mLifetimeManuallyManaged": "所属技能的持续时间可控制", "rootAbility_mName": "所属技能名称", "rootAbility_mType": "所属技能类型", "rootAbility_AbilityTraits": "所属技能特征旗标", "spellHotKey": "技能热键", "ObjectName": "指令对象名称", "mScriptName": "脚本名称", "mSpell flags": "指令旗标", "mSpell mAffectsTypeFlags": "作用目标类型旗标", "mSpell mAffectsStatusFlags": "作用状态旗标", "mSpell mRequiredUnitTags mObjectTagList": "所需目标单位标签列表", "mSpell mExcludedUnitTags mObjectTagList": "无效目标单位标签列表", "mSpell mPlatformSpellInfo mAvatarLevelRequired": "展现化身所需等级", "mSpell mPlatformSpellInfo mSpellID": "指令序号", "mSpell mPlatformSpellInfo mPlatformEnabled": "大区可用性", "mSpell mPlatformSpellInfo mGameModes": "适用游戏模式", "mSpell mCastRequirementsCaster": "施法条件", "mSpell mCastRequirementsTarget": "施法目标条件", "mSpell mAlternateName": "指令别名", "mSpell mSpellTags": "指令标签", "mSpell mEffectAmount": "效应因子", "mSpell DataValues": "数值", "mSpell DataValuesModeOverride": "模式覆盖数值", "mSpell {b08bc498}": "模式覆盖基础充能时间", "mSpell {f9c2333e}": "模式覆盖基础冷却时间", "mSpell mSpellCalculations": "数值计算", "mSpell mCoefficient": "系数1", "mSpell mCoefficient2": "系数2", "mSpell mAnimationName": "动画名称", "mSpell mAnimationLoopName": "动画循环名称", "mSpell mAnimationWinddownName": "淡出动画名称", "mSpell mImgIconName": "缩略图路径列表", "mSpell mKeywordWhenAcquired": "获得技能时的关键字", "mSpell PassiveSpellAffectedByCooldown": "被动技能冷却时间受技能急速影响", "mSpell ImgIconPath": "缩略图路径", "mSpell mMinimapIconName": "小地图缩略图路径", "mSpell mCastTime": "施法时间", "mSpell mChannelDuration": "引导持续时间", "mSpell cooldownTime": "基础冷却时间", "mSpell delayCastOffsetPercent": "施法偏移百分比", "mSpell delayTotalTimePercent": "施法总时间百分比", "mSpell mStartCooldown": "冷却计时时间点", "mSpell mIsDelayedByCastLocked": "施法锁定延迟", "mSpell mPreCastLockoutDeltaTime": "施法前锁定状态时间", "mSpell mPreCastLockoutDeltaTimeData mSpellLockDeltaTimeCalculation": "施法前锁定状态时间计算", "mSpell mPostCastLockoutDeltaTime": "施法后锁定状态时间", "mSpell mCasterPositionEndOfCastUpdate": "施法后更新施法者位置参数", "mSpell mCharacterPassiveBuffs": "被动技能增益", "mSpell mChargeUpdateInterval": "充能数更新间隔（秒）", "mSpell mCancelChargeOnRecastTime": "取消冲锋的再次施法冻结时间（秒）", "mSpell mCastRangeGrowthMax": "施法范围成长最大值", "mSpell mCastRangeGrowthStartTime": "施法范围成长开始时间", "mSpell mCastRangeGrowthDuration": "施法范围成长持续时间", "mSpell {48201b0d}": "", "mSpell {f4ca428f}": "", "mSpell mMaxAmmo": "最大充能数", "mSpell mAmmoUsed": "可用充能数", "mSpell mAmmoRechargeTime": "基础充能时间", "mSpell mAmmoNotAffectedByCDR": "充能时间不受冷却缩减影响", "mSpell mCostAlwaysShownInUI": "总是显示技能消耗", "mSpell mCooldownNotAffectedByCDR": "冷却时间不受冷却缩减影响", "mSpell mAmmoCountHiddenInUI": "充能数隐藏", "mSpell cannotBeSuppressed": "不受压制影响", "mSpell mCanTriggerChargeSpellWhileDisabled": "受到限制效果时仍能触发冲锋技能", "mSpell canCastWhileDisabled": "受到限制效果时仍能施法", "mSpell canCastOrQueueWhileCasting": "施放其它技能时允许施法或进入施法队列", "mSpell mCantCancelWhileWindingUp": "施法后无法取消", "mSpell mCantCancelWhileWindingUpTargetingChampion": "对目标英雄施放后无法取消", "mSpell mCantCancelWhileChanneling": "引导时无法取消", "mSpell cantCastWhileRooted": "定身时无法施放", "mSpell mChannelIsInterruptedByDisables": "引导过程会被限制效果打断", "mSpell mChannelIsInterruptedByAttacking": "引导过程会被普通攻击打断", "mSpell mApplyAttackDamage": "施加攻击伤害", "mSpell mApplyAttackEffect": "施加攻击效果", "mSpell mApplyMaterialOnHitSound": "命中时触发音效", "mSpell mDoesntBreakChannels": "不打断引导过程", "mSpell mCursorChangesInGrass": "鼠标指针在草丛中变化", "mSpell mCursorChangesInTerrain": "鼠标指针在地形中变化", "mSpell mIsDisabledWhileDead": "阵亡时禁用", "mSpell canOnlyCastWhileDead": "仅阵亡时可施放", "mSpell mBelongsToAvatar": "化身型技能", "mSpell mProjectTargetToCastRange": "仅在最大施法位置处施放", "mSpell mSpellRevealsChampion": "技能暴露施法者视野", "mSpell mUseMinimapTargeting": "允许通过小地图施法", "mSpell mMinimapIconRotation": "小地图图标可旋转", "mSpell mUseChargeChanneling": "引导时冲锋", "mSpell ShowChannelBarPerSpellLevelOverride": "不同等级是否展示引导条", "mSpell castRangeUseBoundingBoxes": "从边界框开始计算施法距离", "mSpell mCanMoveWhileChanneling": "引导时可移动", "mSpell mDisableCastBar": "禁用施法条", "mSpell mShowChannelBar": "显示引导条", "mSpell alwaysSnapFacing": "施法时立即转向", "mSpell useAnimatorFramerate": "使用动画生成器帧率", "mSpell bHaveHitEffect": "具有命中特效", "mSpell mOrientRadiusTextureFromPlayer": "从玩家定义纹理半径", "mSpell bIsToggleSpell": "开关型技能", "mSpell mDoNotNeedToFaceTarget": "施法时不需要面向目标", "mSpell mNoWinddownIfCancelled": "打断后不会触发技能结束效果", "mSpell mTurnSpeedScalar": "转向速度标量", "mSpell mIgnoreRangeCheck": "施法时不检查距离", "mSpell mUpdateRotationWhenCasting": "施法时更新服务器轮转", "mSpell mPingableWhileDisabled": "禁用时可标记", "mSpell mOverrideAttackTime mTotalAttackTimeSecs": "覆盖攻击时间计算", "mSpell mOverrideAttackTime SetOverrideAttackDelay": "启用攻击延迟覆盖", "mSpell mOverrideAttackTime mCastTimePercent": "施放时间百分比", "mSpell mUseAutoattackCastTimeData mAutoattackCastTimeCalculation": "自动攻击时间计算", "mSpell mUseAutoattackCastTimeData mUseCastTimeAsTotalTime": "自动攻击时间作为总攻击时间", "mSpell mConsideredAsAutoAttack": "视为自动攻击", "mSpell mIgnoreAnimContinueUntilCastFrame": "动画直到施放帧时持续", "mSpell mHideRangeIndicatorWhenCasting": "施法时隐藏距离指示器", "mSpell mDoesNotConsumeMana": "不消耗法力值", "mSpell mLockedSpellOriginationCastID": "激活时锁定技能施放起源ID", "mSpell mDoesNotConsumeCooldown": "不立即进入冷却时间", "mSpell mRollForCriticalHit": "参与暴击概率计算", "mSpell mMinimapIconDisplayFlag": "小地图缩略图显示旗标", "mSpell ShouldReceiveInputEvents": "需要接收输入事件以保持", "mSpell castRange": "施法范围", "mSpell castRangeDisplayOverride": "显示施法范围", "mSpell castRadius": "施法半径", "mSpell castRadiusSecondary": "次要施法半径", "mSpell castConeAngle": "施法锥角度", "mSpell castConeDistance": "施法锥距离", "mSpell castTargetAdditionalUnitsRadius": "施法物体作用半径", "mSpell luaOnMissileUpdateDistanceInterval": "Lua脚本更新导弹距离间隔", "mSpell mMissileSpec mMissileWidth": "弹体宽度", "mSpell mMissileSpec movementComponent mUseHeightOffsetAtEnd": "弹体移动要素：在目标位置使用高度偏移", "mSpell mMissileSpec movementComponent mVisualsTrackHiddenTargets": "弹体移动要素：视觉效果追踪隐形目标", "mSpell mMissileSpec movementComponent {03046674}": "", "mSpell mMissileSpec movementComponent mTracksTarget": "弹体移动要素：追踪目标", "mSpell mMissileSpec movementComponent mTargetHeightAugment": "弹体移动要素：目标高度调整值", "mSpell mMissileSpec movementComponent mOffsetInitialTargetHeight": "弹体移动要素：初始目标高度偏移量", "mSpell mMissileSpec movementComponent mStartBoneName": "弹体移动要素：起始骨骼名称", "mSpell mMissileSpec movementComponent mStartBoneSkinOverrides": "弹体移动要素：皮肤覆盖起始骨骼名称", "mSpell mMissileSpec movementComponent mTargetBoneName": "弹体移动要素：目标骨骼名称", "mSpell mMissileSpec movementComponent mInferDirectionFromFacingIfNeeded": "弹体移动要素：需要时从面向推断移动方向", "mSpell mMissileSpec movementComponent mProjectTargetToCastRange": "弹体移动要素：将弹体投射到施法范围内", "mSpell mMissileSpec movementComponent AddBonusAttackRangeToCastRange": "弹体移动要素：基于额外攻击距离提升施法距离", "mSpell mMissileSpec movementComponent mTurnRadiusByLevel": "弹体移动要素：基于等级的转向半径", "mSpell mMissileSpec movementComponent mUseGroundHeightAtTarget": "弹体移动要素：在目标位置使用地面高度", "mSpell mMissileSpec movementComponent mSplineInfo mStartPositionOffset": "弹体移动要素：样条曲线信息：起始位置偏移量", "mSpell mMissileSpec movementComponent mSplineInfo mUseMissilePositionAsOrigin": "弹体移动要素：样条曲线信息：使用弹体当前位置作为曲线原点", "mSpell mMissileSpec movementComponent mSplineInfo mControlPoint1": "弹体移动要素：样条曲线信息：控制点1", "mSpell mMissileSpec movementComponent mSplineInfo mControlPoint2": "弹体移动要素：样条曲线信息：控制点2", "mSpell mMissileSpec movementComponent mSplineInfo __type": "弹体移动要素：样条曲线信息：曲线类型", "mSpell mMissileSpec movementComponent mUseMissilePositionAsOrigin": "弹体移动要素：使用弹体当前位置作为原点", "mSpell mMissileSpec movementComponent mSpeed": "弹体移动要素：移动速度", "mSpell mMissileSpec movementComponent mTravelTime": "弹体移动要素：飞行时间", "mSpell mMissileSpec movementComponent mAcceleration": "弹体移动要素：加速度", "mSpell mMissileSpec movementComponent mMinSpeed": "弹体移动要素：最小速度", "mSpell mMissileSpec movementComponent mMaxSpeed": "弹体移动要素：最大速度", "mSpell mMissileSpec movementComponent mInitialSpeed": "弹体移动要素：初始速度", "mSpell mMissileSpec movementComponent mAngularVelocity": "弹体移动要素：角速度", "mSpell mMissileSpec movementComponent mLinearVelocity": "弹体移动要素：线速度", "mSpell mMissileSpec movementComponent mLifetime": "弹体移动要素：生命周期", "mSpell mMissileSpec movementComponent mAxisOfRotation": "弹体移动要素：旋转轴", "mSpell mMissileSpec movementComponent mRotateAroundCasterFacingDirection": "弹体移动要素：围绕施法者面向方向旋转", "mSpell mMissileSpec movementComponent mDrag": "弹体移动要素：阻力系数", "mSpell mMissileSpec movementComponent mWallSliding": "弹体移动要素：是否沿墙壁滑动", "mSpell mMissileSpec movementComponent mWallSlidingFrictionMultiplier": "弹体移动要素：墙壁滑动摩擦系数", "mSpell mMissileSpec movementComponent ParametricMovementType __type": "弹体移动要素：参数化移动类型", "mSpell mMissileSpec movementComponent MovementEntries": "弹体移动要素：移动项目", "mSpell mMissileSpec movementComponent mCounterClockwise": "弹体移动要素：逆时针旋转", "mSpell mMissileSpec movementComponent mWallOffset": "弹体移动要素：向墙外偏移量", "mSpell mMissileSpec movementComponent mWallLength": "弹体移动要素：沿墙壁移动长度", "mSpell mMissileSpec movementComponent mWallSearchRadius": "弹体移动要素：墙壁搜索半径", "mSpell mMissileSpec movementComponent mStopHalfwayAround": "弹体移动要素：中途停止", "mSpell mMissileSpec movementComponent UsePointSmoothing": "弹体移动要素：使用点平滑处理", "mSpell mMissileSpec movementComponent mAntiLagDelay": "弹体移动要素：实时引导抗延迟补偿", "mSpell mMissileSpec movementComponent __type": "弹体移动要素类型", "mSpell mMissileSpec missileGroupSpawners": "弹体组生成器", "mSpell mMissileSpec visibilityComponent mTargetControlsVisibility": "弹体可视要素：目标可见性可控", "mSpell mMissileSpec visibilityComponent mMissileClientExitFOWPrediction": "弹体可视要素：预测弹体脱离战争迷雾时的移动", "mSpell mMissileSpec visibilityComponent mPerceptionBubbleRadius": "弹体可视要素：感知气泡半径", "mSpell mMissileSpec visibilityComponent mMissileClientWaitForTargetUpdateBeforeMissileShow": "弹体可视要素：客户端显示弹体前等待目标更新", "mSpell mMissileSpec visibilityComponent TrailTimeToConsiderForVisibility": "弹体可视要素：用于可见性考虑的轨迹存留时间", "mSpell mMissileSpec visibilityComponent mVisibleToOwnerTeamOnly": "弹体可视要素：仅对友方可见", "mSpell mMissileSpec visibilityComponent __type": "弹体可视要素类型", "mSpell mMissileSpec heightSolver mHeightOffset": "弹体高度求解器：高度偏移量", "mSpell mMissileSpec heightSolver mMaxSlope": "弹体高度求解器：最大坡度", "mSpell mMissileSpec heightSolver mGravity": "弹体高度求解器：重力因子", "mSpell mMissileSpec heightSolver {922c17e5}": "", "mSpell mMissileSpec heightSolver mVerticalOffset": "弹体高度求解器：垂直偏移量", "mSpell mMissileSpec heightSolver mAmplitude": "弹体高度求解器：波形振幅", "mSpell mMissileSpec heightSolver mNumberOfPeriods": "弹体高度求解器：波形周期", "mSpell mMissileSpec heightSolver {827af87a}": "", "mSpell mMissileSpec heightSolver mInitialTargetHeightOffset": "弹体高度求解器：初始目标高度偏移量", "mSpell mMissileSpec heightSolver __type": "弹体高度求解器类型", "mSpell mMissileSpec verticalFacing __type": "弹体垂直朝向类型", "mSpell mMissileSpec behaviors": "弹体行为", "mSpell mMissileSpec {c195fba6}": "", "mSpell mCastType": "施法类型", "mSpell castFrame": "施法帧数", "mSpell missileSpeed": "弹体速度", "mSpell mMissileEffectName": "弹体特效名称", "mSpell mMissileEffectKey": "弹体特效键", "mSpell MissileEffectMaxTurnSpeedDegreesPerSecond": "弹体最大转向速度", "mSpell MissileEffectMaximumAngleDegrees": "弹体最大转动角度", "mSpell mMissileEffectPlayerKey": "玩家弹体特效键", "mSpell mMissileEffectEnemyKey": "敌方弹体特效键", "mSpell mLineWidth": "线条宽度", "mSpell mLineDragLength": "线条拖拽长度", "mSpell mResourceResolvers": "资源解析列表", "mSpell mLookAtPolicy": "观察策略", "mSpell mHitEffectOrientType": "命中效果定向类型", "mSpell mHitEffectName": "命中效果名称", "mSpell mHitEffectKey": "命中效果键", "mSpell mAfterEffectKey": "后续效果键", "mSpell mAfterEffectName": "后续效果名称", "mSpell bHaveHitBone": "具有命中骨骼", "mSpell mHitBoneName": "命中骨骼名称", "mSpell mParticleStartOffset": "粒子起始偏移量", "mSpell mFloatVarsDecimals": "浮点数显示精度", "mSpell mana": "法力值消耗", "mSpell manaUiOverride": "显示法力值消耗", "mSpell selectionPriority": "选择优先级", "mSpell mTargetingTypeData {0fb5bbd7}": "", "mSpell mTargetingTypeData mCanCompleteCastWithoutTarget": "目标类型数据：在目标消失时可完成施法", "mSpell mTargetingTypeData DetectionRange": "目标类型数据：目标检测距离", "mSpell mTargetingTypeData mBrushCursor": "目标类型数据：草丛指针方案", "mSpell mTargetingTypeData mRiverCursor": "目标类型数据：河流指针方案", "mSpell mTargetingTypeData mWallCursor": "目标类型数据：墙壁指针方案", "mSpell mTargetingTypeData __type": "目标类型", "mSpell mAIData": "人工智能数据", "mSpell {8958fee2} {ffcbd9e2}": "", "mSpell {8958fee2} {79a2e7aa}": "", "mSpell SpellEventToAudioEventSuffix": "技能触发音效事件映射表", "mSpell TargetingForgivenessDefinitions": "目标选择容错", "mSpell mSpellCooldownOrSealedQueueThreshold": "冷却队列阈值", "mSpell mDimensionBehavior": "维度行为", "mSpell mCastingBreaksStealth": "施法时打破潜行状态", "mSpell mCastingRevealsCasterStealth": "施法时暴露潜行者视野", "mSpell mCastingBreaksStealthWhileAttached": "施法附着时打破潜行状态", "mSpell mClientData mUseTooltipFromAnotherSpell": "其它技能的说明文本", "mSpell mClientData mMissileTargeterDefinitions": "弹体目标器定义", "mSpell mClientData mUseDeathRecapTooltipFromAnotherSpell": "其它技能的死亡回放说明文本", "mSpell mClientData mTooltipData mObjectName": "说明文本对象名称", "mSpell mClientData mTooltipData mFormat": "说明文本格式", "mSpell mClientData mTooltipData EnableExtendedTooltip": "扩展说明文本可用性", "mSpell mClientData mTooltipData mLocKeys keyNameUnformatted": "未格式化名称键", "mSpell mClientData mTooltipData mLocKeys keyKaynHackType": "凯隐专用升级类型键", "mSpell mClientData mTooltipData mLocKeys keyKaynHackValue": "凯隐专用升级数值键", "mSpell mClientData mTooltipData mLocKeys keyName": "名称键", "mSpell mClientData mTooltipData mLocKeys keyHotkey": "热键", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp": "厄斐琉斯专用升级文本键", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_Name": "厄斐琉斯专用升级文本属性名称键", "mSpell mClientData mTooltipData mLocKeys keySummary": "简介键", "mSpell mClientData mTooltipData mLocKeys keyTooltip": "说明文本键", "mSpell mClientData mTooltipData mLocKeys keyCost": "消耗施法资源", "mSpell mClientData mTooltipData mLocKeys keyTooltipSimple": "简要描述键", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtended": "详细描述键", "mSpell mClientData mTooltipData mLocKeys keyCooldown": "冷却时间键", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtendedBelowLine": "附加文本键", "mSpell mClientData mTooltipData mLocKeys keyNameUnformatted_content_zh": "未格式化名称（中文）", "mSpell mClientData mTooltipData mLocKeys keyNameUnformatted_content_en": "未格式化名称（英文）", "mSpell mClientData mTooltipData mLocKeys keyKaynHackType_content_zh": "凯隐特有升级类型（中文）", "mSpell mClientData mTooltipData mLocKeys keyKaynHackType_content_en": "凯隐特有升级类型（英文）", "mSpell mClientData mTooltipData mLocKeys keyKaynHackValue_content_zh": "凯隐特有升级数值（中文）", "mSpell mClientData mTooltipData mLocKeys keyKaynHackValue_content_en": "凯隐特有升级数值（英文）", "mSpell mClientData mTooltipData mLocKeys keyName_content_zh_burn": "名称（中文）", "mSpell mClientData mTooltipData mLocKeys keyName_content_en_burn": "名称（英文）", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_content_zh": "厄斐琉斯专用升级文本（中文）", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_content_en": "厄斐琉斯专用升级文本（英文）", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_content_zh_burn": "厄斐琉斯专用升级文本（中文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_content_en_burn": "厄斐琉斯专用升级文本（英文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_Name_content_zh": "厄斐琉斯专用升级文本属性名称（中文）", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_Name_content_en": "厄斐琉斯专用升级文本属性名称（英文）", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_Name_content_zh_burn": "厄斐琉斯专用升级文本属性名称（中文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyApheliosHack_TooltipLevelUp_Name_content_en_burn": "厄斐琉斯专用升级文本属性名称（英文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keySummary_content_zh": "简介（中文）", "mSpell mClientData mTooltipData mLocKeys keySummary_content_en": "简介（英文）", "mSpell mClientData mTooltipData mLocKeys keyTooltip_content_zh": "说明文本（中文）", "mSpell mClientData mTooltipData mLocKeys keyTooltip_content_en": "说明文本（英文）", "mSpell mClientData mTooltipData mLocKeys keyTooltip_content_zh_burn": "说明文本（中文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyTooltip_content_en_burn": "说明文本（英文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyCost_content_zh": "消耗施法资源（中文）", "mSpell mClientData mTooltipData mLocKeys keyCost_content_en": "消耗施法资源（英文）", "mSpell mClientData mTooltipData mLocKeys keyCost_content_zh_burn": "消耗施法资源（中文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyCost_content_en_burn": "消耗施法资源（英文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyTooltipSimple_content_zh": "简述（中文）", "mSpell mClientData mTooltipData mLocKeys keyTooltipSimple_content_en": "简述（英文）", "mSpell mClientData mTooltipData mLocKeys keyTooltipSimple_content_zh_burn": "简述（中文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyTooltipSimple_content_en_burn": "简述（英文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtended_content_zh": "详细描述（中文）", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtended_content_en": "详细描述（英文）", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtended_content_zh_burn": "详细描述（中文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtended_content_en_burn": "详细描述（英文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyCooldown_content_zh": "冷却时间（中文）", "mSpell mClientData mTooltipData mLocKeys keyCooldown_content_en": "冷却时间（英文）", "mSpell mClientData mTooltipData mLocKeys keyCooldown_content_zh_burn": "冷却时间（中文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyCooldown_content_en_burn": "冷却时间（英文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtendedBelowLine_content_zh": "附加文本（中文）", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtendedBelowLine_content_en": "附加文本（英文）", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtendedBelowLine_content_zh_burn": "附加文本（中文/数值转换）", "mSpell mClientData mTooltipData mLocKeys keyTooltipExtendedBelowLine_content_en_burn": "附加文本（英文/数值转换）", "mSpell mClientData mTooltipData mLists LevelUp levelCount": "技能等级数量", "mSpell mClientData mTooltipData mLists LevelUp Elements": "技能升级要素", "mSpell mClientData {d66dd6a5}": "", "mSpell mClientData mSpawningUIDefinition buffNameFilter": "生成单位管理：增益名称过滤", "mSpell mClientData mSpawningUIDefinition maxNumberOfUnits": "生成单位管理：最大单位数", "mSpell mClientData mTargeterDefinitions": "目标器定义", "mSpell mClientData mCustomTargeterDefinitions": "个性化目标器定义", "mSpell mClientData mLeftClickSpellAction": "鼠标左键单击动作", "mSpell mClientData mRightClickSpellAction": "鼠标右键单击动作", "mSpell {288b8edc}": "", "mSpell {66769fb4}": "", "CcBehaviorData CcBehavior TargetingParametersList": "自我控制状态下目标选择优先级列表", "CcBehaviorData CcBehavior mSpellFlags": "自我控制技能旗标", "mBuff mDescription": "增益描述键", "mBuff mTooltipData mObjectName": "增益说明文本对象名称", "mBuff mTooltipData mFormat": "增益说明文本格式", "mBuff mTooltipData mLocKeys keyName": "增益名称键", "mBuff mTooltipData mLocKeys keyTooltip": "增益说明文本键", "mBuff mTooltipData mLocKeys keyTooltipSimple": "增益简述键", "mBuff PersistentEffectConditions": "增益持续效果条件", "mBuff CanTimeoutWhileCasting": "增益存在持续时间", "mBuff mShowDuration": "增益显示持续时间", "mBuff mShowAccumulatedDuration": "增益显示累积时间", "mBuff mFloatVarsDecimals": "增益浮点数显示精度", "mBuff mBuffAttributeFlag": "增益属性旗标", "mBuff mDescription_content_zh": "增益描述（中文）", "mBuff mDescription_content_en": "增益描述（英文）", "mBuff mDescription_content_zh_burn": "增益描述（中文/数值转换）", "mBuff mDescription_content_en_burn": "增益描述（英文/数值转换）", "mBuff mTooltipData mLocKeys keyName_content_zh": "增益名称（中文）", "mBuff mTooltipData mLocKeys keyName_content_en": "增益名称（英文）", "mBuff mTooltipData mLocKeys keyTooltip_content_zh": "增益说明文本（中文）", "mBuff mTooltipData mLocKeys keyTooltip_content_en": "增益说明文本（英文）", "mBuff mTooltipData mLocKeys keyTooltip_content_zh_burn": "增益说明文本（中文/数值转换）", "mBuff mTooltipData mLocKeys keyTooltip_content_en_burn": "增益说明文本（英文/数值转换）", "mBuff mTooltipData mLocKeys keyTooltipSimple_content_zh": "增益简述（中文）", "mBuff mTooltipData mLocKeys keyTooltipSimple_content_en": "增益简述（英文）", "mBuff mTooltipData mLocKeys keyTooltipSimple_content_zh_burn": "增益简述（中文/数值转换）", "mBuff mTooltipData mLocKeys keyTooltipSimple_content_en_burn": "增益简述（英文/数值转换）", "BotData": "AI行为决策信息"}
...
class ItemExtractor(LoLDataExtractor):
    ...
    def build_item_dataframe(self, debug: bool = False, path: Optional[str] = None) -> int:
        ...
        item_header: dict[str, str] = {"key": "主键", "spellName": "施法事件名称", "mDisplayName": "显示名键", "mRequiredPurchaseIdentities": "购买所需条件", "mRequiredChampion": "适用英雄", "mRequiredSpellName": "所需指令名", "mDisabledDescriptionOverride": "禁用信息重载", "mDeathRecapName": "死亡回放代码", "mRequiredLevel": "所需英雄等级", "itemID": "装备序号", "maxStack": "最大持有数量", "mItemGroups": "装备分组", "mItemAdviceAttributes": "装备推荐属性", "itemVOGroup": "装备音效分组", "price": "合成费用", "mRequiredBuffCurrencyCost": "其它费用", "mItemCalloutPlayer": "购买时弹出提示", "mRequiredBuffCurrencyName": "其它货币类型", "RestrictedBuffName": "限定增益名称", "consumed": "消耗品", "usableInStore": "商店中可用", "consumeOnAcquire": "购买时消耗", "clickable": "可单击使用", "mHiddenFromOpponents": "对手不可见", "mItemCalloutSpectator": "观战购买时弹出提示", "ShowCooldownVfxToAllies": "友军可见冷却时间", "ShowCooldownInPings": "可标记冷却时间", "mCanBeSold": "可以售出", "specialRecipe": "特殊合成材料序号", "epicness": "稀有度指数", "SecondaryEpicness": "次要稀有度指数", "sidegradeItemLinks": "同级替换路径", "mEffectAmount": "因子取值", "recipeItemLinks": "合成路径", "requiredItemLinks": "所需装备路径", "mScripts": "指令", "mItemModifiers": "装备调整策略", "mDataValues": "数值", "mFlatAttackRangeMod": "固定攻击距离", "mPercentArmorPenetrationMod": "护甲穿透", "DataValuesModeOverride": "模式数值重载", "mItemCalculations": "装备数值计算", "mEffectByLevelAmount": "等级成长效果", "{fe87f21e}": "攻击特效伤害计算", "mPercentTenacityItemMod": "韧性", "mFlatMovementSpeedMod": "移动速度固定值", "StringCalculations": "字符串计算方式", "mAbilityHasteMod": "技能急速", "mFlatArmorPenetrationMod": "穿甲", "mPercentMagicPenetrationMod": "法术穿透百分比", "mFlatMagicPenetrationMod": "法术穿透固定值", "mFlatHPPoolMod": "生命值", "mPercentSlowResistMod": "减速抗性", "mFlatHPRegenMod": "生命回复", "mPercentBaseHPRegenMod": "基础生命回复", "mFlatCritChanceMod": "暴击几率", "mFlatCritDamageMod": "暴击伤害", "mPercentMovementSpeedMod": "移动速度百分比", "mFlatArmorMod": "护甲", "mFlatSpellBlockMod": "魔法抗性", "mFlatPhysicalDamageMod": "攻击力", "PhysicalLethality": "穿甲", "mPercentAttackSpeedMod": "攻击速度", "mPercentMultiplicativeAttackSpeedMod": "总攻击速度", "mPercentLifeStealMod": "生命偷取", "mFlatMagicDamageMod": "法术强度", "PercentOmnivampMod": "全能吸血", "mPercentHealingAmountMod": "治疗和护盾强度", "percentBaseMPRegenMod": "基础法力回复", "flatMPPoolMod": "法力值", "sellBackModifier": "售价折扣", "flatMPRegenMod": "法力回复", "mCooldownShowDisabledDuration": "冷却时间冻结持续时长", "mItemDataBuild": "同品类装备合成信息", "mCategories": "类别", "mItemDataAvailability": "数据可用性", "RecommendationTags": "推荐标签", "mItemAttributes": "装备属性", "{4f958685}": "装备复制来源", "ShopOrderPriority": "商店排序优先级", "LastMajorChangeMajorPatchVersion": "装备效果重做大版本", "LastMajorChangeMinorPatchVersion": "装备效果重做小版本", "mItemDataClient": "客户端数据", "mVFXResourceResolver": "视觉效果资源解析", "mDisplayName_content_zh": "显示名（中文）", "mDisplayName_content_en": "显示名（英文）", "mItemAdviceAttributes_content": "装备推荐属性内容", "totalPrice": "总费用", "specialRecipe_displayName_content_zh": "特殊合成材料（中文）", "specialRecipe_displayName_content_en": "特殊合成材料（英文）", "rarity": "位阶", "secondaryRarity": "次要位阶", "sidegradeItemNames_content_zh": "同级替换装备（中文）", "sidegradeItemNames_content_en": "同级替换装备（英文）", "recipeItemNames_content_zh": "合成材料（中文）", "recipeItemNames_content_en": "合成材料（英文）", "requiredItemNames_content_zh": "所需材料（中文）", "requiredItemNames_content_en": "所需材料（英文）", "mItemDataBuildNames_content_zh": "同品类合成装备（中文）", "mItemDataBuildNames_content_en": "同品类合成装备（英文）", "LastMajorChangeVersion": "装备效果重做版本", "mItemDataAvailability mInStore": "商店可见性", "mItemDataAvailability mForceLoad": "强制加载", "mItemDataAvailability mHidefromAll": "对所有人隐藏", "mItemDataClient mTooltipData mObjectName": "详细信息对象名称", "mItemDataClient mTooltipData mFormat": "详细信息格式", "mItemDataClient mTooltipData EnableExtendedTooltip": "详细信息可展开", "mItemDataClient mTooltipData mLocKeys keyName": "名称键", "mItemDataClient mTooltipData mLocKeys keyActive": "主动效果键", "mItemDataClient mTooltipData mLocKeys keyTooltip": "详细信息键", "mItemDataClient mTooltipData mLocKeys keyShopOnlyText": "仅商店呈现文本键", "mItemDataClient mTooltipData mLocKeys keyFlavorText": "旁白键", "mItemDataClient mTooltipData mLocKeys keyBrief": "简介键", "mItemDataClient mTooltipData mLocKeys keySummary": "总结键", "mItemDataClient mTooltipData mLocKeys keyInventoryOnlyText": "仅装备栏呈现文本键", "mItemDataClient mTooltipData mLocKeys keyActiveInventory": "主动效果动态描述键", "mItemDataClient mTooltipData mLocKeys keyColloquialism": "检索键", "mItemDataClient mTooltipData mLocKeys keyTooltipInventory": "装备栏详细信息键", "mItemDataClient mTooltipData mLocKeys keyTooltipInventoryExtended": "装备栏展开详细信息键", "mItemDataClient mTooltipData mLocKeys keyTooltipExternal": "外部详细信息键", "mItemDataClient mTooltipData mLocKeys keyTooltipExtended": "展开详细信息键", "mItemDataClient mTooltipData mLocKeys keySecondaryBrief": "次要简介键", "mItemDataClient mTooltipData mLocKeys keyKeywordDefinitions": "关键词定义键", "mItemDataClient mTooltipData mLocKeys keyActiveExternal": "外部主动效果键", "mItemDataClient mTooltipData mLocKeys keyTooltipExtendedRules": "详细信息拓展规则键", "mItemDataClient mTooltipData mLocKeys keyActiveExtended": "展开主动效果键", "mItemDataClient mTooltipData mLocKeys keyPrice": "价格键", "mItemDataClient mTooltipData mLists Stats Elements": "属性元素", "mItemDataClient mDescription": "描述键", "mItemDataClient mDynamicTooltip": "动态详细信息键", "mItemDataClient mShopTooltip": "商店详细信息键", "mItemDataClient inventoryIcon": "装备栏图标", "mItemDataClient InventoryIconSmall": "装备栏小图标", "mItemDataClient InventoryIconLarge": "装备栏大图标", "mItemDataClient epicness": "客户端内稀有度指数", "mItemDataClient effectRadius": "影响范围半径", "mItemDataClient InventoryIconMaterial": "装备栏图标修饰材料", "mItemDataClient mFloatVarsDecimals": "小数位数控制", "mItemDataClient mTooltipData mStatList": "属性效果", "mItemDataClient mTooltipData mLocKeys keyName_content_zh": "名称（中文）", "mItemDataClient mTooltipData mLocKeys keyName_content_en": "名称（英文）", "mItemDataClient mTooltipData mLocKeys keyActive_content_zh": "主动效果（中文）", "mItemDataClient mTooltipData mLocKeys keyActive_content_zh_burn": "主动效果（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyActive_content_en": "主动效果（英文）", "mItemDataClient mTooltipData mLocKeys keyActive_content_en_burn": "主动效果（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltip_content_zh": "详细信息（中文）", "mItemDataClient mTooltipData mLocKeys keyTooltip_content_zh_burn": "详细信息（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltip_content_en": "详细信息（英文）", "mItemDataClient mTooltipData mLocKeys keyTooltip_content_en_burn": "详细信息（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyShopOnlyText_content_zh": "仅商店呈现文本（中文）", "mItemDataClient mTooltipData mLocKeys keyShopOnlyText_content_zh_burn": "仅商店呈现文本（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyShopOnlyText_content_en": "仅商店呈现文本（英文）", "mItemDataClient mTooltipData mLocKeys keyShopOnlyText_content_en_burn": "仅商店呈现文本（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyFlavorText_content_zh": "旁白（中文）", "mItemDataClient mTooltipData mLocKeys keyFlavorText_content_en": "旁白（英文）", "mItemDataClient mTooltipData mLocKeys keyBrief_content_zh": "简介（中文）", "mItemDataClient mTooltipData mLocKeys keyBrief_content_zh_burn": "简介（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyBrief_content_en": "简介（英文）", "mItemDataClient mTooltipData mLocKeys keyBrief_content_en_burn": "简介（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keySummary_content_zh": "总结（中文）", "mItemDataClient mTooltipData mLocKeys keySummary_content_zh_burn": "总结（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keySummary_content_en": "总结（英文）", "mItemDataClient mTooltipData mLocKeys keySummary_content_en_burn": "总结（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyInventoryOnlyText_content_zh": "仅装备栏呈现文本（中文）", "mItemDataClient mTooltipData mLocKeys keyInventoryOnlyText_content_zh_burn": "仅装备栏呈现文本（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyInventoryOnlyText_content_en": "仅装备栏呈现文本（英文）", "mItemDataClient mTooltipData mLocKeys keyInventoryOnlyText_content_en_burn": "仅装备栏呈现文本（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyActiveInventory_content_zh": "主动效果动态描述（中文）", "mItemDataClient mTooltipData mLocKeys keyActiveInventory_content_zh_burn": "主动效果动态描述（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyActiveInventory_content_en": "主动效果动态描述（英文）", "mItemDataClient mTooltipData mLocKeys keyActiveInventory_content_en_burn": "主动效果动态描述（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyColloquialism_content_zh": "检索关键字（中文）", "mItemDataClient mTooltipData mLocKeys keyColloquialism_content_en": "检索关键字（英文）", "mItemDataClient mTooltipData mLocKeys keyTooltipInventory_content_zh": "装备栏详细信息（中文）", "mItemDataClient mTooltipData mLocKeys keyTooltipInventory_content_zh_burn": "装备栏详细信息（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipInventory_content_en": "装备栏详细信息（英文）", "mItemDataClient mTooltipData mLocKeys keyTooltipInventory_content_en_burn": "装备栏详细信息（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipInventoryExtended_content_zh": "装备栏展开详细信息（中文）", "mItemDataClient mTooltipData mLocKeys keyTooltipInventoryExtended_content_zh_burn": "装备栏展开详细信息（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipInventoryExtended_content_en": "装备栏展开详细信息（英文）", "mItemDataClient mTooltipData mLocKeys keyTooltipInventoryExtended_content_en_burn": "装备栏展开详细信息（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipExternal_content_zh": "外部详细信息（中文）", "mItemDataClient mTooltipData mLocKeys keyTooltipExternal_content_zh_burn": "外部详细信息（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipExternal_content_en": "外部详细信息（英文）", "mItemDataClient mTooltipData mLocKeys keyTooltipExternal_content_en_burn": "外部详细信息（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipExtended_content_zh": "展开详细信息（中文）", "mItemDataClient mTooltipData mLocKeys keyTooltipExtended_content_zh_burn": "展开详细信息（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipExtended_content_en": "展开详细信息（英文）", "mItemDataClient mTooltipData mLocKeys keyTooltipExtended_content_en_burn": "展开详细信息（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keySecondaryBrief_content_zh": "次要简介（中文）", "mItemDataClient mTooltipData mLocKeys keySecondaryBrief_content_zh_burn": "次要简介（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keySecondaryBrief_content_en": "次要简介（英文）", "mItemDataClient mTooltipData mLocKeys keySecondaryBrief_content_en_burn": "次要简介（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyKeywordDefinitions_content_zh": "关键词定义（中文）", "mItemDataClient mTooltipData mLocKeys keyKeywordDefinitions_content_en": "关键词定义（英文）", "mItemDataClient mTooltipData mLocKeys keyActiveExternal_content_zh": "外部主动效果（中文）", "mItemDataClient mTooltipData mLocKeys keyActiveExternal_content_zh_burn": "外部主动效果（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyActiveExternal_content_en": "外部主动效果（英文）", "mItemDataClient mTooltipData mLocKeys keyActiveExternal_content_en_burn": "外部主动效果（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipExtendedRules_content_zh": "详细信息拓展规则（中文）", "mItemDataClient mTooltipData mLocKeys keyTooltipExtendedRules_content_zh_burn": "详细信息拓展规则（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyTooltipExtendedRules_content_en": "详细信息拓展规则（英文）", "mItemDataClient mTooltipData mLocKeys keyTooltipExtendedRules_content_en_burn": "详细信息拓展规则（英文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyActiveExtended_content_zh": "展开主动效果（中文）", "mItemDataClient mTooltipData mLocKeys keyActiveExtended_content_zh_burn": "展开主动效果（中文/数值转换）", "mItemDataClient mTooltipData mLocKeys keyActiveExtended_content_en": "展开主动效果（英文）", "mItemDataClient mTooltipData mLocKeys keyActiveExtended_content_en_burn": "展开主动效果（英文/数值转换）", "mItemDataClient mDescription_content_zh": "描述（中文）", "mItemDataClient mDescription_content_zh_burn": "描述（中文/数值转换）", "mItemDataClient mDescription_content_en": "描述（英文）", "mItemDataClient mDescription_content_en_burn": "描述（英文/数值转换）", "mItemDataClient mDynamicTooltip_content_zh": "动态详细信息（中文）", "mItemDataClient mDynamicTooltip_content_zh_burn": "动态详细信息（中文/数值转换）", "mItemDataClient mDynamicTooltip_content_en": "动态详细信息（英文）", "mItemDataClient mDynamicTooltip_content_en_burn": "动态详细信息（英文/数值转换）", "mItemDataClient mShopTooltip_content_zh": "商店详细信息（中文）", "mItemDataClient mShopTooltip_content_zh_burn": "商店详细信息（中文/数值转换）", "mItemDataClient mShopTooltip_content_en": "商店详细信息（英文）", "mItemDataClient mShopTooltip_content_en_burn": "商店详细信息（英文/数值转换）", "mItemDataClient rarity": "客户端内位阶"}
        ...
        itemGroup_header: dict[str, str] = {"key": "主键", "mItemGroupID": "装备分组名称", "mItemModifiers": "装备修饰方案", "mInventorySlotMin": "装备栏最小槽位号", "mInventorySlotMax": "装备栏最大槽位号", "mMaxGroupOwnable": "组内最多持有装备数量", "{dbc029fa}": "", "mPurchaseCooldown": "连点预防间隔（秒）"}
        ...
        itemModifier_header: dict[str, str] = {"key": "主键", "mItemModifierID": "装备修饰名称", "mModifiedIfBuildsFromItem": "合成构件包含以下装备时修饰", "mModifiedItem": "修饰装备", "mDeltaMaxStacks": "最大持有数量变化值", "mModifiedGroup": "修饰装备分组", "mMaximumModifierInstancesToBeActive": "最大生效实例数量", "{06d9d838}": "修饰前的基础构件", "{917537a9}": "修饰后的基础构件", "mModifierIsInheritedByOwnedParentItems": "大件继承构件修饰", "mIgnoreSpecificMaxGroupOwnable": "不受其它最大持有数量限制影响", "mMaximumDeltasToStack": "效果叠加次数最大变化量", "mShowAsModifiedInUI": "显示为已修饰", "mDeltaGoldCostPercent": "折扣", "mDeltaRequiredLevel": "所需等级变化值", "mDeltaGoldCost": "固定价格变化", "mDescriptionToReplace": "替代简述键", "mDynamicTooltipToReplace": "替代动态详细信息键", "mVisualPriority": "计分板排列优先级", "inventoryIconToOverlay": "装备栏覆盖图标路径", "mDescriptionToAppend": "追加简述键", "mDynamicTooltipToAppend": "追加动态详细信息键", "mDisplayNameToAppend": "追加显示名键", "mDisplayNameToReplace": "替代显示名键", "mDisplayNameToPrepend": "前附显示名键", "mClickableToEnable": "单击使用技能", "mSpellNameToReplace": "取代技能名称", "{20b65c83}": "升级边框方案名称", "mModifiedIfBuildsFromItem_mDisplayName_content_zh": "修饰构件装备名称（中文）", "mModifiedIfBuildsFromItem_mDisplayName_content_en": "修饰构件装备名称（英文）", "mModifiedItem_mDisplayName_content_zh": "修饰装备名称（中文）", "mModifiedItem_mDisplayName_content_en": "修饰装备名称（英文）", "{06d9d838}_mDisplayName_content_zh": "修饰前的基础构件名称（中文）", "{06d9d838}_mDisplayName_content_en": "修饰前的基础构件名称（英文）", "{917537a9}_mDisplayName_content_zh": "修饰后的基础构件名称（中文）", "{917537a9}_mDisplayName_content_en": "修饰后的基础构件名称（英文）", "mDescriptionToReplace_content_zh": "替代简述（中文）", "mDescriptionToReplace_content_en": "替代简述（英文）", "mDynamicTooltipToReplace_content_zh": "替代动态详细信息（中文）", "mDynamicTooltipToReplace_content_en": "替代动态详细信息（英文）", "mDescriptionToAppend_content_zh": "追加简述（中文）", "mDescriptionToAppend_content_en": "追加简述（英文）", "mDynamicTooltipToAppend_content_zh": "追加动态详细信息（中文）", "mDynamicTooltipToAppend_content_en": "追加动态详细信息（英文）", "mDisplayNameToAppend_content_zh": "追加显示名（中文）", "mDisplayNameToAppend_content_en": "追加显示名（英文）", "mDisplayNameToReplace_content_zh": "替代显示名（中文）", "mDisplayNameToReplace_content_en": "替代显示名（英文）", "mDisplayNameToPrepend_content_zh": "前附显示名（中文）", "mDisplayNameToPrepend_content_en": "前附显示名（英文）"}
...
class AugmentExtractor(LoLDataExtractor):
    ...
    def build_augment_dataframe(self, debug: bool = False, paths: Optional[list[str]] = None) -> int:
        ...
        CherryAugment_header: dict[str, str] = {"key": "主键", "AugmentNameId": "强化符文代码", "Enabled": "可用性", "NameTra": "名称键", "DescriptionTra": "简介键", "AugmentTooltipTra": "强化符文详细信息键", "RootSpell": "根指令", "mAugmentTags": "强化符文标签", "mBuildTags": "构建标签", "AugmentLargeIconPath": "强化符文大图标路径", "AugmentSmallIconPath": "强化符文小图标路径", "AugmentDisplayTags": "强化符文显示标签", "rarity": "稀有度", "AugmentPlatformId": "强化符文序号", "NameTra_content_zh": "名称（中文）", "NameTra_content_en": "名称（英文）", "DescriptionTra_content_zh": "简介（中文）", "DescriptionTra_content_zh_burn": "简介（中文/数值转换）", "DescriptionTra_content_en": "简介（英文）", "DescriptionTra_content_en_burn": "简介（英文/数值转换）", "AugmentTooltipTra_content_zh": "强化符文详细信息（中文）", "AugmentTooltipTra_content_zh_burn": "强化符文详细信息（中文/数值转换）", "AugmentTooltipTra_content_en": "强化符文详细信息（英文）", "AugmentTooltipTra_content_en_burn": "强化符文详细信息（英文/数值转换）", "AugmentDisplayTags_content": "强化符文显示标签内容", "rarityValue": "位阶", "RootSpellObject": "根指令对象"}
        ...
        KiwiAugmentSet_header: dict[str, str] = {"key": "主键", "{3a942548}": "套装代码", "{4217d741}": "套装缩略图路径", "{0746ade9}": "套装名称键", "{97e82990}": "套装描述键", "augments": "强化符文列表", "{96b4b430}": "根指令", "{01d14504}": "资源解析器", "TierData": "位阶数据", "{0746ade9}_content_zh": "套装名称（中文）", "{0746ade9}_content_en": "套装名称（英文）", "{97e82990}_content_zh": "套装描述（中文）", "{97e82990}_content_zh_burn": "套装描述（中文/数值转换）", "{97e82990}_content_en": "套装描述（英文）", "{97e82990}_content_en_burn": "套装描述（英文/数值转换）", "augments nameTra_contents_zh": "强化符文名称列表（中文）", "augments nameTra_contents_en": "强化符文名称列表（英文）", "{96b4b430}_object": "根指令对象", "{96b4b430}_object keyTooltip": "套装说明文本键", "{96b4b430}_object keyTooltip_content_zh": "套装说明文本（中文）", "{96b4b430}_object keyTooltip_content_zh_burn": "套装说明文本（中文/数值转换）", "{96b4b430}_object keyTooltip_content_en": "套装说明文本（英文）", "{96b4b430}_object keyTooltip_content_en_burn": "套装说明文本（英文/数值转换）", "{01d14504} Map": "资源解析器映射字典"}
...
class AnvilExtractor(LoLDataExtractor):
    ...
    def build_anvil_dataframe(self, debug: bool = False, paths: Optional[list[str]] = None) -> int:
        ...
        CherryAnvil_header: dict[str, str] = {"key": "主键", "AugmentNameId": "锻造器代码", "Enabled": "可用性", "NameTra": "名称键", "DescriptionTra": "简介键", "AugmentTooltipTra": "锻造器详细信息键", "RootSpell": "根指令", "mAugmentTags": "锻造器标签", "mBuildTags": "构建标签", "AugmentLargeIconPath": "锻造器大图标路径", "AugmentSmallIconPath": "锻造器小图标路径", "AugmentDisplayTags": "锻造器显示标签", "AnvilTypes": "锻造器类型", "ItemLink": "装备链接", "NameTra_content_zh": "名称（中文）", "NameTra_content_en": "名称（英文）", "DescriptionTra_content_zh": "简介（中文）", "DescriptionTra_content_zh_burn": "简介（中文/数值转换）", "DescriptionTra_content_en": "简介（英文）", "DescriptionTra_content_en_burn": "简介（英文/数值转换）", "AugmentTooltipTra_content_zh": "锻造器详细信息（中文）", "AugmentTooltipTra_content_zh_burn": "锻造器详细信息（中文/数值转换）", "AugmentTooltipTra_content_en": "锻造器详细信息（英文）", "AugmentTooltipTra_content_en_burn": "锻造器详细信息（英文/数值转换）", "AugmentDisplayTags_content": "锻造器显示标签内容", "anvilRarities": "锻造器位阶", "RootSpellObject": "根指令对象"}
...
class TFTExtractor(LoLDataExtractor):
    ...
    def build_tft_dataframe(self, debug: bool = False, path: Optional[str] = None) -> int:
        ...
        ##云顶之弈赛季（TFT Set）
        TFTSet_header: dict[str, str] = {"key": "主键", "name": "赛季代码", "CoreName": "核心代码", "displayName": "显示名键", "TftGameType": "云顶之弈游戏类型代号", "number": "赛季号", "AugmentContainerTexture": "强化符文容器纹理", "AugmentContainerName": "强化符文容器名称", "{46413d37}": "", "{ecb7a24b}": "", "DebugCharacterLists": "调试角色列表", "characterLists": "地图角色列表", "tftCharacterLists": "云顶之弈角色列表", "itemLists": "装备列表", "TraitLists": "羁绊列表", "{0a8ae70b}": "羁绊变异列表", "{8d56bbf6}": "其它装备列表", "ShopDataLists": "商店数据列表", "DropRateTables": "掉率列表", "ShopContentData": "商店内容键", "{c4274f58}": "小队规划器", "ScriptData": "指令数据", "StageRoundData": "回合阶段键", "{34e20808}": "", "{fc63519e}": "特殊回合阶段键", "{46bf1dcb}": "传送门列表键", "{44933d76}": "强化符文规则名称", "EncounterList": "奇遇事件列表键", "{e6c62bd9}": "", "{8e557b7b}": "六费卡指令列表", "{032ade10}": "赛博装备列表", "VfxResourceResolver": "视觉特效资源解析器", "{f99705af}": "其它资源解析器列表", "AudioFeature": "音频特征", "{c8369109}": "六费卡指令说明键", "{4bf0e5a9}": "六费单位属性键", "{235a8995}": "六费单位音效键", "InfoNubData TitleKey": "特定赛季提示标题键", "InfoNubData BodyKey": "特定赛季提示主体键", "InfoNubData Trait": "特定赛季羁绊键", "InfoNubData {eb74e3c6}": "特定赛季掉率信息路径", "InfoNubData ActiveTitleKey": "特定赛季活动提示标题键", "InfoNubData ActiveBodyKey": "特定赛季活动提示主体键", "InfoNubData InactiveTitleKey": "特定赛季非活动提示标题键", "InfoNubData InactiveBodyKey": "特定赛季非活动提示主体键", "InfoNubData UnitProperty": "特定赛季单位属性键", "InfoNubData __type": "特定赛季数据类型", "GameStartSequenceOverride": "游戏开始序列覆盖", "AugmentUiOverride BaseLoadable": "强化符文PC端显示界面", "AugmentUiOverride MobileLoadable": "强化符文移动端显示界面", "UnitShopUiOverride BaseLoadable": "弈子PC端商店显示界面", "UnitShopUiOverride MobileLoadable": "弈子移动端商店显示界面", "{0f5c7941} BaseLoadable": "", "{0f5c7941} MobileLoadable": "", "{1d43802b} BaseLoadable": "", "{1d43802b} MobileLoadable": "", "{9370f055} BaseLoadable": "", "{9370f055} MobileLoadable": "", "{dacd2fc1} {07e29603}": "", "{dacd2fc1} {a211c44d}": "", "{dacd2fc1} {27c5053e}": "", "{aafd4216} {24d36c27} TRAKey": "", "{aafd4216} {ee609993} TRAKey": "", "{aafd4216} {8fba48a3} TRAKey": "", "{aafd4216} {382a7131} TRAKey": "", "{aafd4216} {8e758f9d} TRAKey": "", "{aafd4216} {a7b22c38} TRAKey": "", "{aafd4216} {3754d0ae} TRAKey": "", "{aafd4216} {807eed8a} TRAKey": "", "{ee70bdd4}": "二进制容器路径", "{40d2e7e6}": "通告键", "{47f76f2b}": "装备边框配置", "{a91dafb1}": "特殊弈子和羁绊", "{912b57cb}": "", "{52e4eea2}": "默认棋盘皮肤键", "{416ab5f5}": "", "CompanionHealthPerTickMark": "小小英雄生命值分度值", "{412bcd03}": "推荐阵容", "BotSkillData": "电脑玩家难度等级", "{22cc712f}": "弈子解锁里程", "{bdb41827}": "", "{8876469a}": "独特玩法名称键", "{876a220d}": "签名格键", "{c58ff569}": "加农炮击键", "{049d68aa}": "人机对战敌方单位配置键", "{37ed6c58}": "子赛季列表", "{08dad7b8}": "", "{0d042916}": "", "{1743f77c}": "背景颗粒键名", "displayName_content_zh": "显示名（中文）", "displayName_content_en": "显示名（英文）", "InfoNubData TitleKey_content_zh": "特定赛季提示标题（中文）", "InfoNubData TitleKey_content_en": "特定赛季提示标题（英文）", "InfoNubData BodyKey_content_zh": "特定赛季提示主体（中文）", "InfoNubData BodyKey_content_en": "特定赛季提示主体（英文）", "InfoNubData BodyKey_content_zh_burn": "特定赛季提示主体（中文/数值转换）", "InfoNubData BodyKey_content_en_burn": "特定赛季提示主体（英文/数值转换）", "InfoNubData Trait mDisplayNameTra_content_zh": "特定赛季羁绊显示名（中文）", "InfoNubData Trait mDisplayNameTra_content_en": "特定赛季羁绊显示名（英文）", "InfoNubData ActiveTitleKey_content_zh": "特定赛季活动提示标题（中文）", "InfoNubData ActiveTitleKey_content_en": "特定赛季活动提示标题（英文）", "InfoNubData ActiveBodyKey_content_zh": "特定赛季活动提示主体（中文）", "InfoNubData ActiveBodyKey_content_en": "特定赛季活动提示主体（英文）", "InfoNubData ActiveBodyKey_content_zh_burn": "特定赛季活动提示主体（中文/数值转换）", "InfoNubData ActiveBodyKey_content_en_burn": "特定赛季活动提示主体（英文/数值转换）", "InfoNubData InactiveTitleKey_content_zh": "特定赛季非活动提示标题（中文）", "InfoNubData InactiveTitleKey_content_en": "特定赛季非活动提示标题（英文）", "InfoNubData InactiveBodyKey_content_zh": "特定赛季非活动提示主体（中文）", "InfoNubData InactiveBodyKey_content_en": "特定赛季非活动提示主体（英文）", "InfoNubData InactiveBodyKey_content_zh_burn": "特定赛季非活动提示主体（中文/数值转换）", "InfoNubData InactiveBodyKey_content_en_burn": "特定赛季非活动提示主体（英文/数值转换）", "{aafd4216} {24d36c27} TRAKey_content_zh": "", "{aafd4216} {24d36c27} TRAKey_content_en": "", "{aafd4216} {ee609993} TRAKey_content_zh": "", "{aafd4216} {ee609993} TRAKey_content_en": "", "{aafd4216} {8fba48a3} TRAKey_content_zh": "", "{aafd4216} {8fba48a3} TRAKey_content_en": "", "{aafd4216} {382a7131} TRAKey_content_zh": "", "{aafd4216} {382a7131} TRAKey_content_en": "", "{aafd4216} {8e758f9d} TRAKey_content_zh": "", "{aafd4216} {8e758f9d} TRAKey_content_en": "", "{aafd4216} {a7b22c38} TRAKey_content_zh": "", "{aafd4216} {a7b22c38} TRAKey_content_en": "", "{aafd4216} {3754d0ae} TRAKey_content_zh": "", "{aafd4216} {3754d0ae} TRAKey_content_en": "", "{aafd4216} {807eed8a} TRAKey_content_zh": "", "{aafd4216} {807eed8a} TRAKey_content_en": "", "{47f76f2b} content": "装备边框配置信息", "BotSkillData SkillAxes": "电脑玩家难度配置", "{8876469a}_content_zh": "独特玩法名称（中文）", "{8876469a}_content_en": "独特玩法名称（英文）", "DebugCharacterLists characters": "调试角色", "characterLists characters": "地图角色", "tftCharacterLists characters": "云顶之弈角色", "{0a8ae70b} TraitAssignments": "羁绊变异详细信息", "ShopDataLists ShopData": "云顶之弈商店信息", "ShopDataLists ShopData mDisplayNameTra_content_zh": "云顶之弈商品名称（中文）", "ShopDataLists ShopData mDisplayNameTra_content_en": "云顶之弈商品名称（英文）", "ShopContentData TierBags": "各星级弈子供应信息", "StageRoundData stages": "回合阶段代码", "{46bf1dcb} RegionPortals RegionTra_contents_zh": "地区传送门名称列表（中文）", "{46bf1dcb} RegionPortals RegionTra_contents_en": "地区传送门名称列表（英文）", "{46bf1dcb} {48a30fbc}": "通用传送门列表", "EncounterList {23c80d88} names": "开场奇遇事件名称列表", "EncounterList Encounters names": "奇遇事件名称列表", "{032ade10} {9a7587b2}": "赛博装备键", "{032ade10} {9a7587b2} mDisplayNameTra_contents_zh": "赛博装备名称（中文）", "{032ade10} {9a7587b2} mDisplayNameTra_contents_en": "赛博装备名称（英文）", "VfxResourceResolver resourceMap": "视觉特效资源映射字典", "{f99705af} resourceMap": "其它资源解析器映射字典", "{c8369109} name": "六费卡指令名说明代码", "{c8369109} TitleTra": "六费卡指令说明标题键", "{c8369109} SubtitleTra": "六费卡指令说明副标题键", "{c8369109} DescriptionTra": "六费卡指令说明描述键", "{c8369109} TitleTra_content_zh": "六费卡指令说明标题（中文）", "{c8369109} TitleTra_content_en": "六费卡指令说明标题（英文）", "{c8369109} SubtitleTra_content_zh": "六费卡指令说明副标题（中文）", "{c8369109} SubtitleTra_content_en": "六费卡指令说明副标题（英文）", "{c8369109} DescriptionTra_content_zh": "六费卡指令说明描述（中文）", "{c8369109} DescriptionTra_content_en": "六费卡指令说明描述（英文）", "{c8369109} DescriptionTra_content_zh_burn": "六费卡指令说明描述（中文/数值转换）", "{c8369109} DescriptionTra_content_en_burn": "六费卡指令说明描述（英文/数值转换）", "{235a8995} bankUnits": "六费单位音频单元", "{52e4eea2} name": "默认棋盘皮肤名称", "{52e4eea2} mMapContainerLink": "默认棋盘地图几何容器路径", "{52e4eea2} mMinimapBackgroundConfig mDefaultTextureName": "默认棋盘小地图背景默认纹理名称", "{52e4eea2} mWorldParticlesINI": "默认棋盘世界颗粒配置文件名", "{52e4eea2} mGrassTintTexture": "默认棋盘草地色调纹理", "{52e4eea2} mResourceResolvers": "默认棋盘资源解析器列表", "{876a220d} {7c666488}": "签名格信息", "{c58ff569} {a2cf977c}": "加农炮击对象名", "{c58ff569} {7e6c2447}": "", "{c58ff569} {7c790dbb}": "", "{c58ff569} {a10aa7e1}": "加农炮内可存放装备", "{c58ff569} {0f04526e}": "", "{c58ff569} {0e623b6b}": "", "{c58ff569} {594df5dc}": "加农炮属性键", "{c58ff569} {50badf5e}": "加农炮击触发动作", "{c58ff569} {76b0808b}": "加农炮悬停指令名", "{c58ff569} {ff86a45c}": "加农炮装载装备指令名", "{c58ff569} {216b3a2a}": "加农炮替换装备指令名", "{c58ff569} {d9aa5cc6}": "加农炮发送装备指令名", "{c58ff569} {65cc7400}": "加农炮移除装备指令名", "{c58ff569} {d2211d89}": "加农炮冷却就绪指令名", "{c58ff569} {dfc07418}": "加农炮装备就绪指令名", "{c58ff569} {54adb769}": "加农炮非法行为警告指令名", "{c58ff569} {8770b954}": "加农炮可用提示指令名", "{c58ff569} {1aa4e302}": "加农炮可用提示光效名", "{c58ff569} {4a34b888}": "加农炮可用提示本地化键名", "{c58ff569} {44186edd}": "加农炮掉落装备并交易本地化键名", "{c58ff569} {642004df} {ed713805}": "加农炮发出弈子冷却时间本地化键名", "{c58ff569} {e2902d6a} {ed713805}": "加农炮发出弈子冷却时间信息本地化键名", "{c58ff569} {f18a45bd} {ed713805}": "加农炮基于卡费的冷却时间本地化键名", "{c58ff569} {949fb0ed} {ed713805}": "加农炮计算装备质量期望值本地化键名", "{c58ff569} {9dc7143e} {ed713805}": "加农炮等待我的装备本地化键名", "{c58ff569} {09b885c0} {ed713805}": "加农炮等待搭档装备本地化键名", "{c58ff569} {91c13680}": "加农炮装备具有资格本地化键名", "{c58ff569} {c492805f}": "加农炮不支持所选单位本地化键名", "{c58ff569} {5fa8c2fd} {ed713805}": "加农炮不支持单位星级本地化键名", "{c58ff569} {aa8b3fb6}": "加农炮不支持我的单位本地化键名", "{c58ff569} {81ab8092}": "加农炮不支持搭档单位本地化键名", "{c58ff569} {30e9c19a} {ed713805}": "加农炮无法形成星级说明文本本地化键名", "{c58ff569} {c363ed88}": "加农炮装备交易提示本地化键名", "{c58ff569} {bf072fc1}": "加农炮装备交换提示本地化键名", "{c58ff569} {98b7e581}": "加农炮装备送出提示本地化键名", "{c58ff569} {62ef4bd3} {ed713805}": "加农炮激活回合本地化键名", "{c58ff569} {0b42906e} {ed713805}": "加农炮激活回合信息本地化键名", "{c58ff569} {4a34b888}_content_zh": "加农炮可用提示（中文）", "{c58ff569} {4a34b888}_content_en": "加农炮可用提示（英文）", "{c58ff569} {44186edd}_content_zh": "加农炮掉落装备并交易（中文）", "{c58ff569} {44186edd}_content_en": "加农炮掉落装备并交易（英文）", "{c58ff569} {642004df} {ed713805}_content_zh": "加农炮发出弈子冷却时间（中文）", "{c58ff569} {642004df} {ed713805}_content_en": "加农炮发出弈子冷却时间（英文）", "{c58ff569} {e2902d6a} {ed713805}_content_zh": "加农炮发出弈子冷却时间信息（中文）", "{c58ff569} {e2902d6a} {ed713805}_content_en": "加农炮发出弈子冷却时间信息（英文）", "{c58ff569} {f18a45bd} {ed713805}_content_zh": "加农炮基于卡费的冷却时间（中文）", "{c58ff569} {f18a45bd} {ed713805}_content_en": "加农炮基于卡费的冷却时间（英文）", "{c58ff569} {949fb0ed} {ed713805}_content_zh": "加农炮计算装备质量期望值（中文）", "{c58ff569} {949fb0ed} {ed713805}_content_en": "加农炮计算装备质量期望值（英文）", "{c58ff569} {9dc7143e} {ed713805}_content_zh": "加农炮等待我的装备（中文）", "{c58ff569} {9dc7143e} {ed713805}_content_en": "加农炮等待我的装备（英文）", "{c58ff569} {09b885c0} {ed713805}_content_zh": "加农炮等待搭档装备（中文）", "{c58ff569} {09b885c0} {ed713805}_content_en": "加农炮等待搭档装备（英文）", "{c58ff569} {91c13680}_content_zh": "加农炮装备具有资格（中文）", "{c58ff569} {91c13680}_content_en": "加农炮装备具有资格（英文）", "{c58ff569} {c492805f}_content_zh": "加农炮不支持所选单位（中文）", "{c58ff569} {c492805f}_content_en": "加农炮不支持所选单位（英文）", "{c58ff569} {5fa8c2fd} {ed713805}_content_zh": "加农炮不支持单位星级（中文）", "{c58ff569} {5fa8c2fd} {ed713805}_content_en": "加农炮不支持单位星级（英文）", "{c58ff569} {aa8b3fb6}_content_zh": "加农炮不支持我的单位（中文）", "{c58ff569} {aa8b3fb6}_content_en": "加农炮不支持我的单位（英文）", "{c58ff569} {81ab8092}_content_zh": "加农炮不支持搭档单位（中文）", "{c58ff569} {81ab8092}_content_en": "加农炮不支持搭档单位（英文）", "{c58ff569} {30e9c19a} {ed713805}_content_zh": "加农炮无法形成星级说明文本（中文）", "{c58ff569} {30e9c19a} {ed713805}_content_en": "加农炮无法形成星级说明文本（英文）", "{c58ff569} {c363ed88}_content_zh": "加农炮装备交易提示（中文）", "{c58ff569} {c363ed88}_content_en": "加农炮装备交易提示（英文）", "{c58ff569} {bf072fc1}_content_zh": "加农炮装备交换提示（中文）", "{c58ff569} {bf072fc1}_content_en": "加农炮装备交换提示（英文）", "{c58ff569} {98b7e581}_content_zh": "加农炮装备送出提示（中文）", "{c58ff569} {98b7e581}_content_en": "加农炮装备送出提示（英文）", "{c58ff569} {62ef4bd3} {ed713805}_content_zh": "加农炮激活回合（中文）", "{c58ff569} {62ef4bd3} {ed713805}_content_en": "加农炮激活回合（英文）", "{c58ff569} {0b42906e} {ed713805}_content_zh": "加农炮激活回合信息（中文）", "{c58ff569} {0b42906e} {ed713805}_content_en": "加农炮激活回合信息（英文）", "{049d68aa} {d1edd5db}": "人机对战敌方单位列表", "{049d68aa} {bd2edcd7}": "人机对战敌方单位难度等级", "{049d68aa} {d1edd5db} names": "人机对战敌方单位名称列表"}
        ...
        ##云顶之弈商店（TFT Shop）
        TFTShop_header: dict[str, str] = {"key": "主键", "mName": "商品代码", "mRarity": "稀有度", "{4d4e5cf5}": "平台序号", "BaseCurrency": "基础货币", "BaseCost": "基础卡费", "AbilityIconPath": "技能图标路径", "PcSplashPath": "PC端插画路径", "SquareSplashPath": "方形插画路径", "TeamPlannerSplashPath": "用于小队规划器的插画路径", "TeamPlannerPortraitPath": "用于小队规划器的肖像路径", "mDisplayNameTra": "显示名键", "mAbilityNameTra": "技能名称键", "mDescriptionTra": "描述键", "SellOverwriteTra": "售卖描述键", "{3451d6e4}": "解锁图标路径", "mDisplayNameTra_content_zh": "显示名（中文）", "mDisplayNameTra_content_en": "显示名（英文）", "mAbilityNameTra_content_zh": "技能名称（中文）", "mAbilityNameTra_content_en": "技能名称（英文）", "mDescriptionTra_content_zh": "描述（中文）", "mDescriptionTra_content_en": "描述（英文）", "mDescriptionTra_content_zh_burn": "描述（中文/数值转换）", "mDescriptionTra_content_en_burn": "描述（英文/数值转换）", "SellOverwriteTra_content_zh": "售卖描述（中文）", "SellOverwriteTra_content_en": "售卖描述（英文）"}
        ...
        TFTShopContent_header: dict[str, str] = {"key": "主键", "TierBagIndex": "星级背包索引", "TierBagEntryIndex": "星级背包记录索引", "ShopData": "商品键", "Count": "数量", "ShopData mDisplayNameTra_content_zh": "商品名称（中文）", "ShopData mDisplayNameTra_content_en": "商品名称（英文）"}
        ...
        TFTDropRate_header: dict[str, str] = {"key": "主键", "mDropRatesByLevel Level": "弈士等级", "{4f7d4b97}": "卡费等第数量", "{bcf1e6a6}": "卡费掉率", "{bcf1e6a6}_burn": "卡费掉率字符串"}
        ...
        TFTStageRound_header: dict[str, str] = {"key": "主键", "stageIndex": "阶段序号", "roundIndex": "回合列表", "round_burn": "回合字符串", "round": "回合代码", "round mDisplayNameTra_contents_zh": "回合名称（中文）", "round mDisplayNameTra_contents_en": "回合名称（英文）"}
        ...
        ##云顶之弈回合（TFT Round）
        TFTRound_header: dict[str, str] = {"key": "主键", "mName": "回合代码", "mIconPath": "缩略图路径", "mDisplayNameTra": "回合显示名键", "mDefaultTooltipTra": "默认说明文本键", "mStateTooltipsTra": "状态说明文本键", "mRoundUpcomingIconPath": "即将到来的回合缩略图路径", "mRoundActiveIconPath": "当前回合缩略图路径", "mRoundResultNoneIconPath": "无回合结果缩略图路径", "mRoundResultWinIconPath": "回合胜利缩略图路径", "mRoundResultLossIconPath": "回合失败缩略图路径", "mRoundResultDrawIconPath": "平局缩略图路径", "mDraftArrival mEnabled": "选秀准备阶段可用性", "mDraftArrival mDuration": "选秀准备阶段持续时间", "mDraftArrival mDisplay": "选秀准备阶段显示设置", "mDraftArrival mLabel": "选秀准备阶段标签键", "mDraft mEnabled": "选秀阶段可用性", "mDraft mDuration": "选秀阶段持续时间", "mDraft mDisplay": "选秀阶段显示设置", "mDraftDeparture mEnabled": "选秀离开阶段可用性", "mDraftDeparture mDuration": "选秀离开阶段持续时间", "mPlanningArrival Enabled": "备战准备阶段可用性", "mPlanning mEnabled": "备战阶段可用性", "mPlanning mDuration": "备战阶段持续时间", "mPlanning mDisplay": "备战阶段显示设置", "mPlanning mLabel": "备战阶段标签键", "mPlanning mAnnouncementData": "备战阶段通告键", "mPlanningDeparture mEnabled": "备战离开阶段可用性", "mPlanningDeparture mDuration": "备战离开阶段持续时间", "mPlanningDeparture mDisplay": "备战离开阶段显示设置", "mPlanningDeparture mLabel": "备战离开阶段标签键", "mCombatArrival mEnabled": "战斗开始阶段可用性", "mCombatArrival mDuration": "战斗开始阶段持续时间", "mCombatArrival mDisplay": "战斗开始阶段显示设置", "mCombatArrival mLabel": "战斗开始阶段标签键", "mCombatArrival mAnnouncementData": "战斗开始阶段通告键", "mCombat mEnabled": "战斗阶段可用性", "mCombat mDuration": "战斗阶段持续时间", "mCombat mDisplay": "战斗阶段显示设置", "mCombat mLabel": "战斗阶段标签键", "CombatArtCleanup mEnabled": "战后清场阶段可用性", "CombatArtCleanup mLabel": "战后清场阶段标签键", "mCombatDeparture mEnabled": "战斗离开阶段可用性", "mCombatDeparture mDuration": "战斗离开阶段持续时间", "mCombatDeparture mDisplay": "战斗离开阶段显示设置", "mCombatDeparture mLabel": "战斗离开阶段标签键", "mScriptData": "指令数据", "mDisplayNameTra_content_zh": "回合显示名（中文）", "mDisplayNameTra_content_en": "回合显示名（英文）", "mDefaultTooltipTra_content_zh": "默认说明文本（中文）", "mDefaultTooltipTra_content_en": "默认说明文本（英文）", "mStateTooltipsTra_contents_zh": "状态说明文本（中文）", "mStateTooltipsTra_contents_en": "状态说明文本（英文）", "mDraftArrival mLabel_content_zh": "选秀准备阶段标签（中文）", "mDraftArrival mLabel_content_en": "选秀准备阶段标签（英文）", "mPlanning mLabel_content_zh": "备战阶段标签（中文）", "mPlanning mLabel_content_en": "备战阶段标签（英文）", "mPlanningDeparture mLabel_content_zh": "备战离开阶段标签（中文）", "mPlanningDeparture mLabel_content_en": "备战离开阶段标签（英文）", "mCombatArrival mLabel_content_zh": "战斗开始阶段标签（中文）", "mCombatArrival mLabel_content_en": "战斗开始阶段标签（英文）", "mCombat mLabel_content_zh": "战后阶段标签（中文）", "mCombat mLabel_content_en": "战后阶段标签（英文）", "CombatArtCleanup mLabel_content_zh": "战后清场阶段标签（中文）", "CombatArtCleanup mLabel_content_en": "战后清场阶段标签（英文）", "mCombatDeparture mLabel_content_zh": "战斗离开阶段标签（中文）", "mCombatDeparture mLabel_content_en": "战斗离开阶段标签（英文）"}
        ...
        ##云顶之弈传送门（TFT Portal）
        TFTPortal_header: dict[str, str] = {"key": "主键", "name": "代码", "RegionName": "地区代码", "RegionTra": "地区名称键", "ShortDescriptionTra": "简述键", "LongDescriptionTra": "详细描述键", "{a6b48e18}": "", "IconPath": "缩略图路径", "Color": "RGBA颜色方案", "{308bb787}": "视觉效果资源解析", "type": "传送门类型", "rarity": "传送门稀有度", "effectAmounts": "效应因子", "{98f61e8c}": "", "{ca451de5}": "独特强化符文", "RegionTra_content_zh": "地区名称（中文）", "RegionTra_content_en": "地区名称（英文）", "ShortDescriptionTra_content_zh": "简述（中文）", "ShortDescriptionTra_content_en": "简述（英文）", "ShortDescriptionTra_content_zh_burn": "简述（中文/数值转换）", "ShortDescriptionTra_content_en_burn": "简述（英文/数值转换）", "LongDescriptionTra_content_zh": "详细描述（中文）", "LongDescriptionTra_content_en": "详细描述（英文）", "LongDescriptionTra_content_zh_burn": "详细描述（中文/数值转换）", "LongDescriptionTra_content_en_burn": "详细描述（英文/数值转换）", "{ca451de5} mDisplayNameTra_contents_zh": "独特强化符文显示名（中文）", "{ca451de5} mDisplayNameTra_contents_en": "独特强化符文显示名（英文）"}
        ...
        TFTEncounterDistribution_header: dict[str, str] = {"key": "主键", "name": "代码", "{78442b2f}": "", "{72a9c287}": "", "{b6f73c55}": "", "{abe35607}": "", "{cb4a2ffc}": "", "{b6460367}": "", "{8b21d9dc}": ""}
        ...
        TFTEncounter_header: dict[str, str] = {"key": "主键", "name": "奇遇代码", "{ee030e3d}": "", "{ac397529}": "", "ScriptData": "指令数据", "EncounterTags": "奇遇标签", "ExcludedAugments": "排除的强化符文", "ExcludedEncounters": "排除的奇遇", "AllowedStages": "开放阶段", "{6900f7b1}": "", "{f1f30bb9}": "", "VfxResourceResolver": "视觉效果资源解析器", "{74cf1ad1}": "图像路径", "ExcludedAugments mDisplayNameTra_contents_zh": "排除的强化符文名称（中文）", "ExcludedAugments mDisplayNameTra_contents_en": "排除的强化符文名称（英文）", "VfxResourceResolver resourceMap": "视觉效果资源解析器映射字典"}
        ...
        TFTUnitProperty_header: dict[str, str] = {"key": "主键", "DefaultValue value": "属性默认值", "DefaultValue {82e959c3}": "", "DefaultValue __type": "属性默认值类型", "lifetime": "属性生命周期", "ReplicationRule": "属性复制规则", "CombinationRule": "属性组合规则", "name": "属性名称", "IsCloneable": "属性继承"}
        ...
        TFTCharacterRole_header: dict[str, str] = {"key": "主键", "name": "角色定位代码", "Icon": "角色定位缩略图路径", "CharacterRoleNameTra": "角色定位本地化名称键", "ItemRoleNameTra": "装备定位本地化名称键", "DescriptionTra": "本地化描述键", "{a1ad92a7}": "重制角色定位本地化名称键", "{0116bd9b}": "重制装备定位本地化名称键", "{886be411}": "重制本地化描述键", "items": "装备列表", "CharacterRoleNameTra_content_zh": "角色定位名称（中文）", "CharacterRoleNameTra_content_en": "角色定位名称（英文）", "ItemRoleNameTra_content_zh": "装备定位名称（中文）", "ItemRoleNameTra_content_en": "装备定位名称（英文）", "DescriptionTra_content_zh": "角色定位描述（中文）", "DescriptionTra_content_en": "角色定位描述（英文）", "DescriptionTra_content_zh_burn": "角色定位描述（中文/数值转换）", "DescriptionTra_content_en_burn": "角色定位描述（英文/数值转换）", "{a1ad92a7}_content_zh": "重制角色定位名称（中文）", "{a1ad92a7}_content_en": "重制角色定位名称（英文）", "{0116bd9b}_content_zh": "重制装备定位名称（中文）", "{0116bd9b}_content_en": "重制装备定位名称（英文）", "{886be411}_content_zh": "重制角色定位描述名称（中文）", "{886be411}_content_en": "重制角色定位描述名称（英文）", "{886be411}_content_zh_burn": "重制角色定位描述名称（中文/数值转换）", "{886be411}_content_en_burn": "重制角色定位描述名称（英文/数值转换）", "items mDisplayNameTra_contents_zh": "装备显示名（中文）", "items mDisplayNameTra_contents_en": "装备显示名（英文）"}
        ...
        TFTItemList_header: dict[str, str] = {"key": "主键", "name": "装备列表代码", "mItems": "装备列表", "VfxResourceResolver": "视觉效果资源解析器键", "mItems mDisplayNameTra_content_zh": "装备名称列表（中文）", "mItems mDisplayNameTra_content_en": "装备名称列表（英文）", "VfxResourceResolver resourceMap": "视觉效果资源解析器映射字典"}
        ...
        ##云顶之弈装备（TFT Item）
        TFTItem_header: dict[str, str] = {"key": "主键", "mName": "代码", "mIsUnique": "唯一装备", "value": "效应因子", "mComposition": "装备构件", "mAlternativeCompositions": "其它合成方案", "MutuallyExclusiveItems": "互斥装备键", "IncompatibleTraits": "不兼容羁绊键", "AssociatedTraits": "相关羁绊键", "BonusTrait": "奖励羁绊键", "constants": "数值常数", "ItemTags": "装备标签", "ShopData": "商店信息键", "{609ed8a4}": "所需强化符文", "IsAugment": "强化符文项目", "mDisplayNameTra": "显示名键", "mDescriptionNameTra": "描述键", "UnitPropertyOverrides": "单位属性覆盖", "mArmoryIconOverridePath": "武器库图标覆盖路径", "mIconPath": "缩略图路径", "{41b0f90b}": "用于选择界面的缩略图材料", "IconMaterial": "缩略图材料", "mColor": "RGBA颜色方案", "mRandomAnimationStrengthRange": "随机动画强度范围", "mCodexDisplayIndex": "图鉴显示索引", "AssociatedCharacterName": "相关弈子名称", "VfxResourceResolver": "视觉效果资源解析器", "mComposition mDisplayNameTra_contents_zh": "装备构件名称（中文）", "mComposition mDisplayNameTra_contents_en": "装备构件名称（英文）", "mAlternativeCompositions mDisplayNameTra_contents_zh": "其它合成方案装备构件名称（中文）", "mAlternativeCompositions mDisplayNameTra_contents_en": "其它合成方案装备构件名称（英文）", "MutuallyExclusiveItems mDisplayNameTra_contents_zh": "互斥装备名称（中文）", "MutuallyExclusiveItems mDisplayNameTra_contents_en": "互斥装备名称（英文）", "IncompatibleTraits mDisplayNameTra_contents_zh": "不兼容羁绊名称（中文）", "IncompatibleTraits mDisplayNameTra_contents_en": "不兼容羁绊名称（英文）", "AssociatedTraits mDisplayNameTra_contents_zh": "相关羁绊名称（中文）", "AssociatedTraits mDisplayNameTra_contents_en": "相关羁绊名称（英文）", "BonusTrait mDisplayNameTra_content_zh": "奖励羁绊名称（中文）", "BonusTrait mDisplayNameTra_content_en": "奖励羁绊名称（英文）", "ShopData mDisplayNameTra_content_zh": "商品名称（中文）", "ShopData mDisplayNameTra_content_en": "商品名称（英文）", "mDisplayNameTra_content_zh": "显示名（中文）", "mDisplayNameTra_content_en": "显示名（英文）", "mDisplayNameTra_content_zh_burn": "显示名（中文/数值转换）", "mDisplayNameTra_content_en_burn": "显示名（英文/数值转换）", "mDescriptionNameTra_content_zh": "描述（中文）", "mDescriptionNameTra_content_en": "描述（英文）", "mDescriptionNameTra_content_zh_burn": "描述（中文/数值转换）", "mDescriptionNameTra_content_en_burn": "描述（英文/数值转换）", "VfxResourceResolver resourceMap": "视觉效果资源解析器映射字典"}
        ...
        TFTTraitList_header: dict[str, str] = {"key": "主键", "mTraits": "羁绊键", "VfxResourceResolver": "视觉效果资源解析器", "mTraits mDisplayNameTra_contents_zh": "羁绊名称（中文）", "mTraits mDisplayNameTra_contents_en": "羁绊名称（英文）", "VfxResourceResolver resourceMap": "视觉效果资源解析器映射字典"}
        ...
        ##云顶之弈羁绊（TFT Trait）
        TFTTrait_header: dict[str, str] = {"key": "主键", "mName": "羁绊代码", "mDisplayNameTra": "羁绊显示名键", "mDescriptionNameTra": "羁绊描述键", "{0247448b}": "羁绊简述键", "mIconPath": "缩略图路径", "TraitType": "羁绊类型", "TraitProgressionDisplay": "羁绊进度显示方式", "InnateTraitSets": "固有羁绊效果集", "mConditionalTraitSets": "条件羁绊效果集", "{14b4616a}": "", "mDisplayNameTra_content_zh": "羁绊显示名（中文）", "mDisplayNameTra_content_en": "羁绊显示名（英文）", "mDescriptionNameTra_content_zh": "羁绊描述（中文）", "mDescriptionNameTra_content_en": "羁绊描述（英文）", "mDescriptionNameTra_content_zh_burn": "羁绊描述（中文/数值转换）", "mDescriptionNameTra_content_en_burn": "羁绊描述（英文/数值转换）", "{0247448b}_content_zh": "羁绊简述（中文）", "{0247448b}_content_en": "羁绊简述（英文）", "{0247448b}_content_zh_burn": "羁绊简述（中文/数值转换）", "{0247448b}_content_en_burn": "羁绊简述（英文/数值转换）"}
        ...
        TFTPVENPC_header: dict[str, str] = {"key": "主键", "name": "代码", "championIndex": "英雄索引", "Character": "角色代号", "level": "星级", "Row": "行号", "Col": "列号", "items": "装备", "{801b0cad}": "增益", "Coordinate": "坐标", "items mDescriptionNameTra_contents_zh": "装备名称（中文）", "items mDescriptionNameTra_contents_en": "装备名称（英文）"}
        ...
        ##云顶之弈脚本（TFT Script）
        TFTScript_header: dict[str, str] = {"key": "主键", "mName": "代码", "mConstants": "数值常数", "mRequiredConstantsGroup": "拓展组常数键", "mRequiredConstantsGroup mConstants": "拓展组常数数值"}
        ...
        TFTAnnouncement_header: dict[str, str] = {"key": "主键", "mIconPath": "通告图标路径", "mTitleTra": "通告标题键", "mDuration": "通告持续时间", "mDelay": "通告延迟", "AnimatedIcon": "通告动态图路径", "{1ccc919a}": "通告颗粒效果键", "mTitleTra_content_zh": "通告标题（中文）", "mTitleTra_content_en": "通告标题（英文）"}
